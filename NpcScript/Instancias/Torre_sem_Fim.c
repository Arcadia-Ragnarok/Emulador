...
e_tower,81,105,0	script	Pedra de Proteção	2_MONEMUS,{
	...
	if (has_instance("1@tower") == "") {
		...
		mapannounce ("e_tower", strcharinfo(0)+ " do grupo, "+getarg(3)+", está entrando no calabouço da, Torre Infinita.",bc_map,"0x00ff99",FW_NORMAL,12);
		if (getarg(1)) {
...
1@tower,50,360,0	script	Braseiro Imortal#eT	CLEAR_NPC,{
	...
	mapannounce (instance_mapname("1@tower"), strcharinfo(0)+". Você será teleportado para o "+.@level$[.@i]+" andar.",bc_map,"0x00ff99");
