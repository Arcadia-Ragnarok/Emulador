...
prontera,165,60,2	script	Aprendiz de Artesão#prtEcht	1_F_MERCHANT_01,{
	if (Zeny >= 400000) {
		...
		next;
		mes("[Aprendiz de Artesão]\n"
			"No entanto, você tem que ter em mente que,\n"
			"se houver duas armaduras do mesmo tipo em seu inventário.\n"
		...
		next;
		mes("[Aprendiz de Artesão]\n"
			"Se por acaso, você quiser encantar a sua armadura,\n"
			"traga-me 400,000 zeny e a armadura que pretende encantar e então tudo estará pronto.");
		close;
	}
	...
	if (countitem(.@itemid) == 1) {
		mes("[Aprendiz de Artesão]\n"
			"Adicionar um slot irá lhe custar 400,000 zeny.\n"
