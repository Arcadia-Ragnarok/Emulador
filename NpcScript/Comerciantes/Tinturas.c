...
morocc_in,146,99,3	script	Dullihan#dyestuff	1_M_MERCHANT,{
	if (merchantq > 2) {
		...
		switch (select("Conversar", "Fazer Tinturas", "Cancelar")) {
			...
			if (select("Por favor me conte", "Quem sabe depois") == 1) {
				...
				next;
				mes("[Java Dullihan]\n"
					"Mesmo depois que minha se foi,\n"
					"meu pai manteve-se fazendo tinturas sem descanso.\n"
				...
				next;
				mes("[Java Dullihan]\n"
					"Entretanto, como você pode ver,\n"
					"eu acabei me transformando em um fabricante de tinturas como meu pai.\n"
				...
				mes("[Java Dullihan]\n"
					...
					"Eu sei que é duro compreender,\n"
					"mas você verá que há um significado.");
				next;
				mes("[Java Dullihan]\n"
			...
			mes("[Java Dullihan]\n"
				"Hahahaha...\n"
				"Eu não tenho culpa de não poder adivinhar, o que quer aqui,\n"
				"com um velho fabricante de um tinturas....\n"
				"Hahahaha...");
			close;
			case 2:
			mes("[Java Dullihan]\n"
			...
			next;
			mes("[Java Dullihan]\n"
				"Não seja intimidado pelos preços,\n"
				"elas são todas minhas obras-primas.");
			next;
			mes("[Java Dullihan]\n"
	...
	switch (getarg(0)) {
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Vermelha, eu preciso de\n"
			"^0000ff30 Ervas Vermelhas,\n"
			"1 Antígeno e\n"
			"1 Garrafa Vazia^000000.\n"
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Amarela, eu preciso de\n"
			"^0000ff30 Ervas Amarelas,\n"
			"1 Antígeno, e\n"
			"1 Garrafa Vazia^000000.\n"
			"O custo de minha mão de obra será de 3000 Zeny.");
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Azul, eu preciso de\n"
			"^0000ff20 Ervas Azuis,\n"
			"1 Antígeno, e\n"
			"1 Garrafa Vazia^000000.\n"
			"Trabalhar com ervas azuis é mais difícil,\n"
			"então o custo de minha mão-de-obra será de 3500 Zeny.");
		...
		mes("[Java Dullihan]\n"
			"Hm...\n"
			"Para fazer uma Tintura Verde, eu preciso de\n"
			"^0000ff5 Ervas Azuis,\n"
			"20 Ervas Verdes,\n"
			"20 Ervas Amarelas,\n"
			"1 Antígeno,\n"
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Laranja, eu preciso de\n"
			"^0000ff20 Ervas Vermelha,\n"
			"20 Ervas Amarelas,\n"
			"1 Antígeno,\n"
			"1 Mistura, e\n"
			"1 Garrafa Vazia^000000.\n"
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Violeta, eu preciso de\n"
			"^0000ff10 Ervas Azuis,\n"
			"30 Ervas Vermelhas,\n"
			"1 Antígeno,\n"
			"1 Mistura, e\n"
			"1 Garrafa Vazia^000000.\n"
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Branca, eu preciso de\n"
			"^0000ff30 Ervas Brancas,\n"
			"1 Antígeno, e\n"
			"1 Garrafa Vazia^000000.\n"
			"O custo de minha mão-de-obra será de 3000 Zeny.");
		...
		mes("[Java Dullihan]\n"
			"Hmm...\n"
			"Para fazer uma Tintura Preta, eu preciso de\n"
			"^0000ff30 Ervas Vermelhas,\n"
			"30 Ervas Amarelas,\n"
			"30 Ervas Verdes,\n"
			"5 Ervas Azuis,\n"
	...
	mes("[Java Dullihan]");
	switch (getarg(1)) {
		case 1: mes("Ah! Eu acho que você tem tudo pronto.\n Gostaria de iniciar o processo?"); break;
		case 2: mes("Ok! Eu acho que você tem tudo pronto.\n Gostaria de iniciar o processo?"); break;
		case 3: mes("Ok! Eu acho que você tem tudo pronto.\n Podemos começar o processo?"); break;
		case 4: mes("Ok! Eu acho que você tem tudo pronto.\n Gostaria de iniciar o processo?"); break;
	}
	next;
