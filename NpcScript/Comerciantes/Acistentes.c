...
-	script	MercenaryRent	FAKE_NPC,{
	...
	switch(select("Contratar Acistente", "Informações", "Cancelar")) {
		...
		break;
		case 2:
		mes("[Gerente do Clã]\n Eu sou um gerente responsável pela contratação de acistentes de nosso clã.\n Você pode encontrar outros como em alguns lugares, e cada um responsável pela contrato de acistentes expecíficos.");
		next;
		...
		next;
		mes("[Gerente do Clã]\n Bem, você pode se informar melhor dos detalhes quando você de fato contratar um de nossos Assistentes.\n Você receber o Pergaminho de Invocação que irá convocar um Assistente para lhe escoltar.");
		next;
		mes("[Gerente do Clã]\n Você não pode dar esse pergaminho para outra pessoa e o Assistente só ficará com você até 30 minutos.\n Depois que você convocá-lo.");
		close;
		case 3:
		mes("[Gerente do Clã]\n Tudo bem, se sentir necessidade de nossa ajuda.\n Volte a me procurar.");
		close;
