...
+-------------------------------------------------------------------+
| - Informações                                                     |
| * Cavaleiros da batalha campal Flavius                            |
\*-----------------------------------------------------------------*/
...
-	script	::FlaviusKnt	FAKE_NPC,{
	...
	switch (select("Participar da batalha", "Informações da batalha", "Nada")) {
		case 1:
		mes "[" + strnpcinfo(NPC_NAME_VISIBLE) + "]";
		mes "Para participar da batalha de Flavius.";
		mes "Primeiro você deve se alistar com o ^2C5EC0General Guillaume^000000 ou com o ^BB0000Príncepe Croix^000000.";
