...
| - Copyright: ????????????                                         |
| - Info: Npcs comuns na cidade Geffen                              |
\*-----------------------------------------------------------------*/
...
geffen,59,143,0	script	Meera#gef	4_F_02,{
	...
	next;
	mes "[Meera]";
	mes "Mas isso não é tudo.";
	mes "Há um tipo especial de mel que é feito somente para as Abelhas Rainhas comerem:";
...
geffen_in,39,127,2	script	Vidente#gef	4_M_BIBI,{
	...
	mes "Ah...";
	mes "Não diga!";
	mes "Você veio saber seu futuro, não?";
	mes "Eu sei...";
	mes "Eu sei...";
...
geffen_in,109,72,2	script	Perito em Monstros#gef	4_F_01,{
	...
	switch (select("Area de Monstros","Notícias Recentes","Era dos Monstros","Teoria do Jellopy")) {
		...
		mes "Os monstros não chegam muito perto da cidade.";
		mes "Então aventureiros fatigados podem descansar aqui.";
		next;
		mes "[Estheres]";
