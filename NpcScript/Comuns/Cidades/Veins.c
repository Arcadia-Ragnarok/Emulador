...
| - Copyright: ????????????                                         |
| - Info: Npcs comuns na cidade Veins                               |
\*-----------------------------------------------------------------*/
...
veins,310,195,1	script	Cidadão#vei3	4_M_DST_MASTER,{
	...
	next;
	mes "[Cidadão]";
	mes "Cactos regulares são muito incomuns, mas eu ouvi que no deserto tem um tipo de cacto que faz barulhos irritantes e passeia por aí.";
...
veins,111,50,3	script	Cidadão#vei6	4_M_DESERT,{
	...
	next;
	mes "[Cidadão]";
	mes "Na verdade, começamos a namorar aqui, por isso que este lugar realmente significa muito para mim.";
...
veins,296,184,3	script	Cidadão#vei8	4_F_DESERT,{
	...
	next;
	mes "[Cidadão]";
	mes "Quando chegar a hora, o Templo de Cheshrumnir se abrirá e um robô gingante de Freya sairá!";
...
veins,232,169,5	script	Senhora#vei	4_F_DST_GRAND,{
	mes "[Senhora]";
	mes "...........";
	mes "Quando eu olho a cidade daqui, percebo muitas coisas.";
	...
	mes "Sim, não há nada que substitua a experiência quando se trata de algumas coisas, você verá.";
	close;
}
