...
malangdo,151,120,3	script	Menestrel#mal	4_M_MINSTREL,{
	mes "[Menestrel]";
...
// ------------------------------------------------------------------
malangdo,149,120,5	script	Cigana#mal	4_F_WANDERER,5,1,{
	mes "[Cigana]";
...
// ------------------------------------------------------------------
malangdo,216,168,3	script	Treinador de Gato#mal	4_F_ALCHE_A,0,8,{
	emotion (e_gg);
	mes "[Treinador de Gato]";
	mes "Meu cartão, ^FF0000Silvervine Fruit^000000.";
	mes "Pode fazer todos os gatos em Malangdo meus escravos ~ haha!";
	next;
	...
	next;
	select("Onde eu posso conseguir isso... ^ FF0000Silvervine Fruit^000000?");
	mes "[Treinador de Gato]";
