...
// ------------------------------------------------------------------
dewata,179,204,4	script	Jovem Dama#dew2	4_M_DEWWOMAN,{
	mes "[Jovem Dama]";
...
// ------------------------------------------------------------------
dewata,221,237,5	script	Jovem#dew3	4_M_DEWMAN,{
	...
	switch(select("Sobre a casca..","Sobre a polpa...","Sobre o núcleo...","Nada, obrigado.")) {
		...
		next;
		mes "[Apreciador de Frutas]";
		mes "Hmm... Sim! a polpa do Côco é um pouco mais dura do que a de uma Noz.";
...
// ------------------------------------------------------------------
dewata,279,213,4	script	Turista#dew7	4_M_LIEMAN,2,3,{
	OnTouch:
...
dewata,75,122,6	script	Monge#dewt5	4_M_BUDDHIST,{
	...
	switch(select("Estou visitando.","Não há motivos especiais.")) {
		case 1:
		mes "[Monge]";
		mes "Oh, você é tourist. Essa é a '^0000FFPagoda^000000' adorando ao Grande Buddha.";
...
// ------------------------------------------------------------------
dewata,245,244,4	script	Funcionário do Hotel#dew	4_M_DEWMAN,2,3,{
	OnTouch:
...
// ------------------------------------------------------------------
dewata,233,263,0	script	Casal Apaixonado#dew	4_M_ROGUE,2,3,{
	OnTouch:
...
// ------------------------------------------------------------------
dewata,234,263,0	script	Casal Apaixonado#dew2	4_F_JOB_HUNTER,2,3,{
	OnTouch:
	mes "[Esposa Apaixonada]";
...
// ------------------------------------------------------------------
dewata,278,100,4	script	Criança Desaparecida#dew	4_F_KID2,2,3,{
	OnTouch:
	mes "[Ukki]";
...
// ------------------------------------------------------------------
dewata,249,87,4	script	Mãe#dew	4W_F_01,2,3,{
	OnTouch:
	mes "[Mãe]";
...
// ------------------------------------------------------------------
dewata,278,281,4	script	Vovô Alegre	4_M_DEWOLDMAN,{
	mes "[Vovô Alegre]";
...
// ------------------------------------------------------------------
dewata,280,277,4	script	Vovó Alegre	4_M_DEWOLDWOMAN,{
	mes "[Vovó Alegre]";
...
dewata,165,103,6	script	Aventureiro Semangat#dew	4_M_DEWOLDMAN,{
	mes "[Aventureiro]";
	mes "ambém viajei ao redor do Mundo Quando eu era jovem como você.";
...
dewata,114,243,6	script	Jovem Preguiçoso#dew	4_M_DEWMAN,1,1,{
	if (checkweight(Knife,1) == 0 || MaxWeight - Weight < 500) {
		mes "[Preguiçoso]";
		mes "Porque está todos esses itens com você?";
		mes "Não é muito pesado?";
		close;
	}
...
dewata,146,109,5	script	Cozinheiro#dew	4_COOK,{
	if (checkweight(Nasi_Goreng,1) == 0 || checkweight(Satay,1) == 0 || MaxWeight - Weight < 500) {
		...
		mes "É sempre bom comer quando se está com fome.";
		close;
	}
	mes "[Cozinheiro]";
