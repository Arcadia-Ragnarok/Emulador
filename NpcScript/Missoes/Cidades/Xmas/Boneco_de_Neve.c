...
+-------------------------------------------------------------------+
| - Versão: Spell Master                                            |
| - Nota: Quest do Boneco de Neve                                   |
| - Observação: Requisito na quest de mudança de classe para bardo  |
\*-----------------------------------------------------------------*/
...
// ------------------------------------------------------------------
xmas_in,27,103,4	script	Tia Mima	4_F_GODEMOM,{
	switch (xmas_npc) {
		case 5:
		mes "[Mima]";
		...
		mes "[Mima]";
		mes "*Suspiro*";
		mes "Você não é muito inteligente, amigo.";
		mes "Vá até Boneco de Neve e me traga ^3355FFO Melhor Sal do Mundo^000000.";
		next;
		mes "[Mima]";
		mes "Corra, querido.";
		mes "Chop Chop.!";
		...
		mes "Sabe que Boneco de Neve foi feito com uma neve misteriosa.";
		mes "que cobria um campo de flores mágicas.";
		next;
		mes "[Mima]";
		...
		next;
		mes "[Mima]";
		mes "Nós temos uma Fábrica de Brinquedos";
		mes "'Fábrica de Brinquedos' aqui perto.";
		mes "Bem, não preciso te contar se você já ouviu falar dela.";
		mes "Bem...";
		next;
		mes "[Mima]";
		mes "Percebi uma coisa uns tempos atrás.";
		mes "Na Fábrica de Brinquedos, você encontra criaturas que parecem aquelas que ficam fora da cidade.";
		next;
		mes "[Mima]";
		...
		mes "[Mima]";
		mes "...";
		mes "Ok, agora vou colher vegetais.";
		mes "Se você ainda não sabe, eu tenho os melhores picles da cidade!";
		mes "Por que você não me visita depois e experimenta?";
		close;
	}
}
...
xmas,146,136,4	script	Hashokii	4_M_PIERROT,{
	...
	switch(select("E aí cara, beleza?","Sobre Boneco de Neve","Cancelar")) {
		...
		next;
		mes "[Hashokii]";
		mes "Eles estão ficando cada dia mais espertos e não acham mais graça nas minhas piadas.";
		mes "Como ficaram tão inteligentes?";
		next;
		mes "[Hashokii]";
		mes "Bem, se eu conseguir inventar uma piada realmente boa farei com que eles riam!";
		mes "Então, é melhor eu começar logo.";
		next;
		mes "[Hashokii]";
		mes "La La La.!";
		mes "Dum di Dum di Dum";
		...
		if (xmas_npc == 8) {
			mes "[Hashokii]";
			mes "Dum di Dum di Dum";
			mes "Ah ha! Então você quer saber mais sobre Boneco de Neve!";
			mes "Vejamos...";
			next;
			mes "[Hashokii]";
			mes "Bem, aqui existem duas crianças, ^3355FFCharu Charu^000000 e ^3355FFMarcell^000000.";
			mes "Eles sempre vão no meu show.";
			mes "Acho que Cantata já te contou a história?";
			next;
			mes "[Hashokii]";
			mes "Enfim, sabe os bebês que Boneco de Neve salvou?";
			mes "Sim, são eles mesmos. Mas acho que Charu Charu e Marcell não sabem disso.";
			next;
			mes "[Hashokii]";
			...
			mes "Eles talvez te contem a história completa. Boa sorte.!";
			xmas_npc = 9;
			close;
		}
		else {
			...
			next;
			mes "[Hashokii]";
			mes "Ele é uma ótima audiência para o meu show.";
			mes "Na verdade, não sei se ele realmente gosta.";
			mes "As pessoas não riem muito das minhas piadas.";
			next;
			mes "[Hashokii]";
			mes "Não entendo isso!";
			mes "Como eles podem não rir das melhores piadas do mundo?!";
			next;
			mes "[Hashokii]";
			mes "Hmmm, desculpe!";
			mes "Enfim, Boneco de Neve é um cara ótimo!";
			mes "La La La.!";
			mes "Dum di Dum di Dum";
			mes "Feliz Natal- !!";
			close;
...
// ------------------------------------------------------------------
xmas,208,168,4	script	Pequena Menina	4_F_KID2,{
	if (xmas_npc == 9 || xmas_npc == 10) {
		switch(xmas_npc) {
			case 9:
			mes "[Marcell]";
			mes "Você está falando do Boneco de Neve?";
			mes "Claro que eu conheço ele!";
			next;
			mes "[Marcell]";
			mes "Ele é muito legal e divertido!";
			mes "E como Charu Charu fala, ele é mais engraçado que o Hashokii.";
			mes "Mas não diga isso para o Hashokii!";
			next;
			mes "[Marcell]";
