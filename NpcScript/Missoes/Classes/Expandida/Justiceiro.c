...
|                                                                   |
+-------------------------------------------------------------------+
| - Nota: Quest de Mudança de Classe para Justiceiro.               |
\*-----------------------------------------------------------------*/
...
que_ng,152,167,3	script	Mestre Miller#gunslingerq	4_M_HUOLDARMY,{
	if (Class == Job_Novice) {
		if (JobLevel < 10 || getskilllv("NV_BASIC") < 9) {
			...
			mes "Você tem potencial, mas não tem experiência suficiente.";
		...
		if (gunslingerq == 0) {
			...
			mes "[Mestre Miller]";
			mes "Hm. Você é muito jovem, mas seus olhos dizem que você é bastante ambicios"+(Sex == SEX_MALE ? "o" : "a")+".";
			mes "Você terá que passar em nossa entrevista e curso educacional para se tornar Justiceiro.";
			...
			mes "[Mestre Miller]";
			mes "Leve essa carta de apresentação que escrevi para o Sr. Sábio Chifre de Touro, em Payon.";
			...
			mes "Tudo bem então, vou promovê-lo a Justiceiro.";
			...
			mes "A Guilda dos Justiceiros mantém o controle de todas as Armas e Projéteis, então você só pode obtê-las dos membros da nossa guilda.";
			next;
			mes "[Mestre Miller]";
		...
		if (Class == Job_Gunslinger) {
			mes "[Mestre Miller]";
			mes "Espero que você mantenha sua arma bem cuidada.";
			mes "Cuide dela, e ela cuidará de você.";
			mes "Lembre-se disso.";
			close;
		} else {
			mes "[Mestre Miller]";
...
payon,184,65,3	script	Sábio Chifre de Touro#gunslingerq	4_M_LGTGRAND,{
	if (gunslingerq == 1) {
		...
		mes "Hm, o Raposa Negra não costuma escrever apresentações para qualquer um que ele não acredite que será um bom Justiceiro";
		mes "Sim, eu acho que sei por que ele o mandou a mim.";
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Posso ver em seus olhos que tem um bom coração e um forte senso de responsabilidade.";
		mes "Tudo o que precisa é da bênção da Terra para te proteger como Justiceiro.";
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Eu posso fazer um amuleto que demonstrará seu desejo em se tornar um guerreiro da Terra.";
		...
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Eu estive servindo nesta posição de escolher pessoas dignas do amuleto do Justiceiro por algumas décadas.";
		...
		mes "Como o tempo pode passar tão rápido?";
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Ah...";
		...
		if (countitem(Milk) < 1) {
			mes "[Sábio Chifre de Touro]";
			mes "Eu sou um velho homem que, em breve, se reunirá com a Mãe Terra.";
		...
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Eu admiro a paciência, gentileza, e bondade que você provou trazendo isto para mim.";
		mes "Sim, essas são características que todos nós queremos ter.";
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Agora, por favor, leve esse amuleto para Miller, o Raposa Negra, com toda minha aprovação.";
		...
		mes "[Sábio Chifre de Touro]";
		mes "Por favor, leve esse amuleto para Miller, o Raposa Negra, com toda a minha aprovação.";
		mes "Eu espero que você use sua arma para apoiar a justiça como um nobre guerreiro da Terra.";
		next;
		mes "[Sábio Chifre de Touro]";
		mes "Eeh...Yeah...Hooom....";
