 ...
 */
static bool inter_config_read_log(const char *filename, const struct config_t *config)
{
...
static int inter_init_sql(const char *file)
{
	...
	ShowInfo("Conecando ao servidor de personagens...\n");
