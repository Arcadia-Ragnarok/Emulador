...
static void itemdb_read_packages(void)
{
	...
	const char *config_filename = "Database/Item_DB/Packages.conf";
	const char *itname;
...
static void itemdb_read_options(void)
{
	...
	int index = 0, count = 0;
	const char *filepath = "Database/Item_DB/ItemOptions.conf";
...
static void itemdb_read_chains(void)
{
	...
	const char *config_filename = "Database/Item_DB/ChainList.conf";
