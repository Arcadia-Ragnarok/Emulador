 ...
 * @read Database/AchievementRank.conf
 */
static void achievement_readdb_ranks(void)
{
	const char *filename = "Database/Etc_DB/AchievementRank.conf";
 ...
 * @read Achievement.conf
 */
static void achievement_readb(void)
{
	const char *filename = "Database/Etc_DB/Achievement.conf";
