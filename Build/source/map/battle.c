...
static int64 battle_calc_damage(struct block_list *src, struct block_list *bl, struct Damage *d, int64 damage, uint16 skill_id, uint16 skill_lv)
{
	...
	if( sc && sc->count )
	{
		...
		if( sc->data[SC_LEXAETERNA] && skill_id != PF_SOULBURN && skill_id != CR_ACIDDEMONSTRATION)
		{
		...
		if(sc->data[SC_DEFENDER] && ((flag&(BF_LONG|BF_WEAPON)) == (BF_LONG|BF_WEAPON) || skill_id == CR_ACIDDEMONSTRATION))
		...
		if( sc->data[SC_ENERGYCOAT] && (skill_id == GN_HELLS_PLANT_ATK || ((flag&BF_WEAPON || flag&BF_MAGIC) && skill_id != WS_CARTTERMINATION)) ) {
...
#define GET_NORMAL_ATTACK2( f , s ) ( wd.damage2 = battle->calc_base_damage(src, target, s, skill_lv, nk, n_ele, s_ele, s_ele_, EQI_HAND_L, (f), wd.flag) )
		...
		if((!flag.idef || !flag.idef2) && (!flag.distinct || flag.tdef)) { //Defense reduction
...
static const struct battle_data {
	...
	// BattleGround
	{ "bg_config/bg_update_interval", &battle_config.bg_update_interval, 1000, 100, INT_MAX, },
	{ "bg_config/bg_flee_penalty",    &battle_config.bg_flee_penalty,    20,   0,   INT_MAX, },

	// Client
	{ "client_config/packet_obfuscation",              &battle_config.packet_obfuscation,              1,         0,    3,            },
	{ "client_config/min_chat_delay",                  &battle_config.min_chat_delay,                  0,         0,    INT_MAX,      },
	...
	{ "client_config/min_hair_color",                  &battle_config.min_hair_color,                  0,         0,    INT_MAX,      },
	{ "client_config/max_hair_color",                  &battle_config.max_hair_color,                  9,         0,    INT_MAX,      },
	{ "client_config/min_cloth_color",                 &battle_config.min_cloth_color,                 0,         0,    INT_MAX,      },
	{ "client_config/max_cloth_color",                 &battle_config.max_cloth_color,                 4,         0,    INT_MAX,      },
	{ "client_config/min_body_style",                  &battle_config.min_body_style,                  0,         0,    SHRT_MAX,     },
	{ "client_config/max_body_style",                  &battle_config.max_body_style,                  4,         0,    SHRT_MAX,     },
	{ "client_config/hide_woe_damage",                 &battle_config.hide_woe_damage,                 0,         0,    1,            },
	{ "client_config/pet_hair_style",                  &battle_config.pet_hair_style,                  100,       0,    INT_MAX,      },
	{ "client_config/area_size",                       &battle_config.area_size,                       14,        0,    INT_MAX,      },
	{ "client_config/chat_area_size",                  &battle_config.chat_area_size,                  9,         0,    INT_MAX,      },
	{ "client_config/dead_area_size",                  &battle_config.dead_area_size,                  32,        0,    INT_MAX,      },
	{ "client_config/max_walk_path",                   &battle_config.max_walk_path,                   17,        1,    MAX_WALKPATH, },
	{ "client_config/max_lv",                          &battle_config.max_lv,                          99,        0,    175,          },
	{ "client_config/aura_lv",                         &battle_config.aura_lv,                         99,        0,    INT_MAX,      },
	{ "client_config/client_limit_unit_lv",            &battle_config.client_limit_unit_lv,            0,         0,    BL_ALL,       },
	{ "client_config/wedding_modifydisplay",           &battle_config.wedding_modifydisplay,           0,         0,    1,            },
	{ "client_config/wedding_ignorepalette",           &battle_config.wedding_ignorepalette,           0,         0,    1,            },
	{ "client_config/save_clothcolor",                 &battle_config.save_clothcolor,                 1,         0,    1,            },
	{ "client_config/save_body_style",                 &battle_config.save_body_style,                 0,         0,    1,            },
	{ "client_config/xmas_ignorepalette",              &battle_config.xmas_ignorepalette,              0,         0,    1,            },
	{ "client_config/summer_ignorepalette",            &battle_config.summer_ignorepalette,            0,         0,    1,            },
	...
	{ "client_config/display_version",                 &battle_config.display_version,                 1,         0,    1,            },
	{ "client_config/display_hallucination",           &battle_config.display_hallucination,           1,         0,    1,            },
	{ "client_config/display_status_timers",           &battle_config.display_status_timers,           1,         0,    1,            },
	{ "client_config/client_reshuffle_dice",           &battle_config.client_reshuffle_dice,           0,         0,    1,            },
	{ "client_config/client_sort_storage",             &battle_config.client_sort_storage,             0,         0,    1,            },
	{ "client_config/client_accept_chatdori",          &battle_config.client_accept_chatdori,          0,         0,    INT_MAX,      },
	{ "client_config/client_emblem_max_blank_percent", &battle_config.client_emblem_max_blank_percent, 100,       0,    100,          },
	{ "client_config/mvp_exp_reward_message",          &battle_config.mvp_exp_reward_message,          0,         0,    1,            },
	{ "client_config/display_fake_hp_when_dead",       &battle_config.display_fake_hp_when_dead,       1,         0,    1,            },
	{ "client_config/buying_store",                    &battle_config.feature_buying_store,            1,         0,    1,            },
	{ "client_config/search_stores",                   &battle_config.feature_search_stores,           1,         0,    1,            },
	{ "client_config/banking",                         &battle_config.feature_banking,                 1,         0,    1,            },
	{ "client_config/auction",                         &battle_config.feature_auction,                 0,         0,    2,            },
	{ "client_config/auction_feeperhour",              &battle_config.auction_feeperhour,              12000,     0,    INT_MAX,      },
	{ "client_config/auction_maximumprice",            &battle_config.auction_maximumprice,            500000000, 0,    MAX_ZENY,     },
	...
	{ "drops_config/item_first_get_time",      &battle_config.item_first_get_time,      3000,  0,    INT_MAX, },
	{ "drops_config/item_second_get_time",     &battle_config.item_second_get_time,     1000,  0,    INT_MAX, },
	{ "drops_config/item_third_get_time",      &battle_config.item_third_get_time,      1000,  0,    INT_MAX, },
	{ "drops_config/mvp_item_first_get_time",  &battle_config.mvp_item_first_get_time,  10000, 0,    INT_MAX, },
	{ "drops_config/mvp_item_second_get_time", &battle_config.mvp_item_second_get_time, 10000, 0,    INT_MAX, },
	{ "drops_config/mvp_item_third_get_time",  &battle_config.mvp_item_third_get_time,  2000,  0,    INT_MAX, },
	{ "drops_config/item_rate_common",         &battle_config.item_rate_common,         100,   0,    1000,    },
	{ "drops_config/item_rate_common_boss",    &battle_config.item_rate_common_boss,    100,   0,    1000,    },
	{ "drops_config/item_drop_common_min",     &battle_config.item_drop_common_min,     1,     1,    1000,    },
	{ "drops_config/item_drop_common_max",     &battle_config.item_drop_common_max,     10000, 1,    10000,   },
	{ "drops_config/item_rate_heal",           &battle_config.item_rate_heal,           100,   0,    1000,    },
	{ "drops_config/item_rate_heal_boss",      &battle_config.item_rate_heal_boss,      100,   0,    1000,    },
	{ "drops_config/item_drop_heal_min",       &battle_config.item_drop_heal_min,       1,     1,    1000,    },
	{ "drops_config/item_drop_heal_max",       &battle_config.item_drop_heal_max,       10000, 1,    10000,   },
	{ "drops_config/item_rate_use",            &battle_config.item_rate_use,            100,   0,    1000,    },
	{ "drops_config/item_rate_use_boss",       &battle_config.item_rate_use_boss,       100,   0,    1000,    },
	{ "drops_config/item_drop_use_min",        &battle_config.item_drop_use_min,        1,     1,    1000,    },
	{ "drops_config/item_drop_use_max",        &battle_config.item_drop_use_max,        10000, 1,    10000,   },
	{ "drops_config/item_rate_equip",          &battle_config.item_rate_equip,          100,   0,    1000,    },
	{ "drops_config/item_rate_equip_boss",     &battle_config.item_rate_equip_boss,     100,   0,    1000,    },
	{ "drops_config/item_drop_equip_min",      &battle_config.item_drop_equip_min,      1,     1,    1000,    },
	{ "drops_config/item_drop_equip_max",      &battle_config.item_drop_equip_max,      10000, 1,    10000,   },
	{ "drops_config/item_rate_card",           &battle_config.item_rate_card,           100,   0,    1000,    },
	{ "drops_config/item_rate_card_boss",      &battle_config.item_rate_card_boss,      100,   0,    1000,    },
	{ "drops_config/item_drop_card_min",       &battle_config.item_drop_card_min,       1,     1,    1000,    },
	{ "drops_config/item_drop_card_max",       &battle_config.item_drop_card_max,       10000, 1,    10000,   },
	{ "drops_config/item_rate_mvp",            &battle_config.item_rate_mvp,            100,   0,    1000,    },
	{ "drops_config/item_drop_mvp_min",        &battle_config.item_drop_mvp_min,        1,     1,    1000,    },
	{ "drops_config/item_drop_mvp_max",        &battle_config.item_drop_mvp_max,        10000, 1,    10000,   },
	{ "drops_config/item_rate_adddrop",        &battle_config.item_rate_adddrop,        100,   0,    1000,    },
	{ "drops_config/item_drop_add_min",        &battle_config.item_drop_adddrop_min,    1,     1,    10000,   },
	{ "drops_config/item_drop_add_max",        &battle_config.item_drop_adddrop_max,    10000, 1,    10000,   },
	{ "drops_config/item_rate_treasure",       &battle_config.item_rate_treasure,       100,   0,    1000,    },
	{ "drops_config/item_drop_treasure_min",   &battle_config.item_drop_treasure_min,   1,     1,    1000,    },
	{ "drops_config/item_drop_treasure_max",   &battle_config.item_drop_treasure_max,   10000, 1,    10000,   },
	{ "drops_config/item_logarithmic_drops",   &battle_config.logarithmic_drops,        0,     0,    1,       },
	{ "drops_config/drop_rate0item",           &battle_config.drop_rate0item,           0,     0,    1,       },
	{ "drops_config/drops_by_luk",             &battle_config.drops_by_luk,             0,     0,    INT_MAX, },
	{ "drops_config/drops_by_luk2",            &battle_config.drops_by_luk2,            0,     0,    INT_MAX, },
	{ "drops_config/alchemist_summon_reward",  &battle_config.alchemist_summon_reward,  1,     0,    2,       },

	// Exp
	{ "exp_config/base_exp_rate",          &battle_config.base_exp_rate,          100, 0, 1000,    },
	{ "exp_config/job_exp_rate",           &battle_config.job_exp_rate,           100, 0, 1000,    },
	{ "exp_config/multi_level_up",         &battle_config.multi_level_up,         0,   0, 1,       },
	{ "exp_config/max_exp_gain_rate",      &battle_config.max_exp_gain_rate,      0,   0, 1000,    },
	{ "exp_config/exp_calc_type",          &battle_config.exp_calc_type,          0,   0, 1,       },
	{ "exp_config/exp_bonus_attacker",     &battle_config.exp_bonus_attacker,     25,  0, 1000,    },
	{ "exp_config/exp_bonus_max_attacker", &battle_config.exp_bonus_max_attacker, 12,  2, 1000,    },
	{ "exp_config/mvp_exp_rate",           &battle_config.mvp_exp_rate,           100, 0, 1000,    },
	{ "exp_config/quest_exp_rate",         &battle_config.quest_exp_rate,         100, 0, 1000,    },
	{ "exp_config/heal_exp",               &battle_config.heal_exp,               0,   0, 1000,    },
	{ "exp_config/resurrection_exp",       &battle_config.resurrection_exp,       0,   0, 1000,    },
	{ "exp_config/shop_exp",               &battle_config.shop_exp,               0,   0, 1000,    },
	{ "exp_config/pvp_exp",                &battle_config.pvp_exp,                1,   0, 1,       },
	{ "exp_config/death_penalty_type",     &battle_config.death_penalty_type,     0,   0, 2,       },
	{ "exp_config/death_penalty_base",     &battle_config.death_penalty_base,     0,   0, INT_MAX, },
	{ "exp_config/death_penalty_job",      &battle_config.death_penalty_job,      0,   0, INT_MAX, },
	{ "exp_config/zeny_penalty",           &battle_config.zeny_penalty,           0,   0, INT_MAX, },
	{ "exp_config/disp_experience",        &battle_config.disp_experience,        0,   0, 1,       },
	{ "exp_config/disp_zeny",              &battle_config.disp_zeny,              0,   0, 1,       },
	{ "exp_config/use_statpoint_table",    &battle_config.use_statpoint_table,    1,   0, 1,       },

	// Global
	{ "global_config/status_cast_cancel",        &battle_config.sc_castcancel,            BL_NUL,       BL_NUL, BL_ALL,  },
	{ "global_config/pc_status_def_rate",        &battle_config.pc_sc_def_rate,           100,          0,      INT_MAX, },
	{ "global_config/mob_status_def_rate",       &battle_config.mob_sc_def_rate,          100,          0,      INT_MAX, },
	{ "global_config/pc_max_status_def",         &battle_config.pc_max_sc_def,            100,          0,      INT_MAX, },
	{ "global_config/mob_max_status_def",        &battle_config.mob_max_sc_def,           100,          0,      INT_MAX, },
	{ "global_config/enable_baseatk",            &battle_config.enable_baseatk,           BL_PC|BL_HOM, BL_NUL, BL_ALL,  },
	{ "global_config/enable_perfect_flee",       &battle_config.enable_perfect_flee,      BL_PC|BL_PET, BL_NUL, BL_ALL,  },
	{ "global_config/enable_critical",           &battle_config.enable_critical,          BL_PC,        BL_NUL, BL_ALL,  },
	{ "global_config/mob_critical_rate",         &battle_config.mob_critical_rate,        100,          0,      INT_MAX, },
	{ "global_config/critical_rate",             &battle_config.critical_rate,            100,          0,      INT_MAX, },
	{ "global_config/attack_walk_delay",         &battle_config.attack_walk_delay,        BL_ALL,       BL_NUL, BL_ALL,  },
	{ "global_config/pc_damage_walk_delay_rate", &battle_config.pc_walk_delay_rate,       20,           0,      INT_MAX, },
	{ "global_config/damage_walk_delay_rate",    &battle_config.walk_delay_rate,          100,          0,      INT_MAX, },
	{ "global_config/multihit_delay",            &battle_config.multihit_delay,           80,           0,      INT_MAX, },
	{ "global_config/player_damage_delay_rate",  &battle_config.pc_damage_delay_rate,     100,          0,      INT_MAX, },
	{ "global_config/undead_detect_type",        &battle_config.undead_detect_type,       0,            0,      2,       },
	{ "global_config/attribute_recover",         &battle_config.attr_recover,             1,            0,      1,       },
	{ "global_config/min_hitrate",               &battle_config.min_hitrate,              5,            0,      100,     },
	{ "global_config/max_hitrate",               &battle_config.max_hitrate,              100,          0,      100,     },
	{ "global_config/agi_penalty_type",          &battle_config.agi_penalty_type,         1,            0,      2,       },
	{ "global_config/agi_penalty_target",        &battle_config.agi_penalty_target,       BL_PC,        BL_NUL, BL_ALL,  },
	{ "global_config/agi_penalty_count",         &battle_config.agi_penalty_count,        3,            2,      INT_MAX, },
	{ "global_config/agi_penalty_num",           &battle_config.agi_penalty_num,          10,           0,      INT_MAX, },
	{ "global_config/vit_penalty_type",          &battle_config.vit_penalty_type,         1,            0,      2,       },
	{ "global_config/vit_penalty_target",        &battle_config.vit_penalty_target,       BL_PC,        BL_NUL, BL_ALL,  },
	{ "global_config/vit_penalty_count",         &battle_config.vit_penalty_count,        3,            2,      INT_MAX, },
	{ "global_config/vit_penalty_num",           &battle_config.vit_penalty_num,          5,            0,      INT_MAX, },
	{ "global_config/weapon_defense_type",       &battle_config.weapon_defense_type,      0,            0,      INT_MAX, },
	{ "global_config/magic_defense_type",        &battle_config.magic_defense_type,       0,            0,      INT_MAX, },
	{ "global_config/attack_direction_change",   &battle_config.attack_direction_change,  BL_ALL,       BL_NUL, BL_ALL,  },
	{ "global_config/attack_attr_none",          &battle_config.attack_attr_none,         ~BL_PC,       BL_NUL, BL_ALL,  },
	{ "global_config/equip_natural_break_rate",  &battle_config.equip_natural_break_rate, 0,            0,      INT_MAX, },
	{ "global_config/equip_self_break_rate",     &battle_config.equip_self_break_rate,    100,          0,      INT_MAX, },
	{ "global_config/equip_skill_break_rate",    &battle_config.equip_skill_break_rate,   100,          0,      INT_MAX, },
	{ "global_config/delay_battle_damage",       &battle_config.delay_battle_damage,      1,            0,      1,       },
	{ "global_config/autospell_check_range",     &battle_config.autospell_check_range,    0,            0,      1,       },
	{ "global_config/knockback_left",            &battle_config.knockback_left,           1,            0,      1,       },

	// GM
	{ "gm_config/atcommand_spawn_quantity_limit", &battle_config.atc_spawn_quantity_limit,      100, 0, INT_MAX, },
	{ "gm_config/atcommand_slave_clone_limit",    &battle_config.atc_slave_clone_limit,         25,  0, INT_MAX, },
	{ "gm_config/partial_name_scan",              &battle_config.partial_name_scan,             0,   0, 1,       },
	{ "gm_config/atcommand_max_stat_bypass",      &battle_config.atcommand_max_stat_bypass,     0,   0, 100,     },
	{ "gm_config/ban_hack_trade",                 &battle_config.ban_hack_trade,                0,   0, INT_MAX, },
	{ "gm_config/atcommand_mobinfo_type",         &battle_config.atcommand_mobinfo_type,        0,   0, 1        },
	{ "gm_config/gm_ignore_warpable_area",        &battle_config.gm_ignore_warpable_area,       0,   2, 100,     },
	{ "gm_config/atcommand_levelup_events",       &battle_config.atcommand_levelup_events,      0,   0, 1,       },
	...
	{ "guild_config/castle_defense_rate",     &battle_config.castle_defense_rate,     100, 0, 100,     },
	{ "guild_config/gvg_flee_penalty",        &battle_config.gvg_flee_penalty,        20,  0, INT_MAX, },
	{ "guild_config/require_glory_guild",     &battle_config.require_glory_guild,     0,   0, 1,       },
	{ "guild_config/max_guild_alliance",      &battle_config.max_guild_alliance,      3,   0, 3,       },
	{ "guild_config/guild_notice_changemap",  &battle_config.guild_notice_changemap,  2,   0, 2,       },
	{ "guild_config/guild_castle_invite",     &battle_config.guild_castle_invite,     0,   0, 1,       },
	{ "guild_config/guild_castle_expulsion",  &battle_config.guild_castle_expulsion,  0,   0, 1,       },
	{ "guild_config/emergency_call",          &battle_config.emergency_call,          11,  0, 31,      },
	{ "guild_config/guild_aura",              &battle_config.guild_aura,              31,  0, 31,      },

	// Homunculus
	{ "homunc_config/hom_setting",              &battle_config.hom_setting,                   0xFFFF, 0x0000, 0xFFFF,    },
	{ "homunc_config/homunculus_friendly_rate", &battle_config.homunculus_friendly_rate,      100,    0,      1000,      },
	{ "homunc_config/hom_rename",               &battle_config.hom_rename,                    0,      0,      1,         },
	{ "homunc_config/hvan_explosion_intimate",  &battle_config.hvan_explosion_intimate,       45000,  0,      100000,    },
	{ "homunc_config/homunculus_show_growth",   &battle_config.homunculus_show_growth,        0,      0,      1,         },
	...
	{ "homunc_config/homunculus_max_level",     &battle_config.hom_max_level,                 99,     0,      99,        },
	{ "homunc_config/homunculus_S_max_level",   &battle_config.hom_S_max_level,               150,    0,      150,       },
	{ "homunc_config/enable_homun_autofeed",    &battle_config.feature_enable_homun_autofeed, 1,      0,      1,         },

	// Item
	{ "item_config/vending_max_value",                &battle_config.vending_max_value,                10000000, 1, MAX_ZENY, },
	{ "item_config/vending_over_max",                 &battle_config.vending_over_max,                 1,        0, 1,        },
	{ "item_config/vending_tax",                      &battle_config.vending_tax,                      0,        0, 10000,    },
	{ "item_config/buyer_name",                       &battle_config.buyer_name,                       1,        0, 1,        },
	{ "item_config/weapon_produce_rate",              &battle_config.wp_rate,                          100,      0, 1000,     },
	{ "item_config/potion_produce_rate",              &battle_config.pp_rate,                          100,      0, 1000,     },
	{ "item_config/produce_item_name_input",          &battle_config.produce_item_name_input,          0x1|0x2,  0, 0x9F,     },
	{ "item_config/dead_branch_active",               &battle_config.dead_branch_active,               1,        0, 1,        },
	{ "item_config/random_monster_checklv",           &battle_config.random_monster_checklv,           0,        0, 1,        },
	{ "item_config/ignore_items_gender",              &battle_config.ignore_items_gender,              1,        0, 1,        },
	{ "item_config/item_check",                       &battle_config.item_check,                       0,        0, 0xF,      },
	{ "item_config/item_use_interval",                &battle_config.item_use_interval,                100,      0, INT_MAX,  },
	{ "item_config/gtb_sc_immunity",                  &battle_config.gtb_sc_immunity,                  50,       0, 100,      },
	{ "item_config/autospell_stacking",               &battle_config.autospell_stacking,               0,        0, 1,        },
	{ "item_config/item_restricted_consumption_type", &battle_config.item_restricted_consumption_type, 1,        0, 1,        },
	{ "item_config/item_enabled_npc",                 &battle_config.item_enabled_npc,                 1,        0, 1,        },
	{ "item_config/unequip_restricted_equipment",     &battle_config.unequip_restricted_equipment,     0,        0, 3,        },
	{ "item_config/bow_unequip_arrow",                &battle_config.bow_unequip_arrow,                1,        0, 1,        },
	{ "item_config/boarding_halter_speed",            &battle_config.boarding_halter_speed,            25,       0, 100,      },
	{ "item_config/storage_use_item",                 &battle_config.storage_use_item,                 0,        0, 1,        },
	{ "item_config/min_item_buy_price",               &battle_config.min_item_buy_price,               1,        0, INT_MAX,  },
	{ "item_config/min_item_sell_price",              &battle_config.min_item_sell_price,              0,        0, INT_MAX,  },
	{ "item_config/arrow_decrement",                  &battle_config.arrow_decrement,                  1,        0, 2,        },

	// Monster
	{ "monster_config/mvp_hp_rate",                       &battle_config.mvp_hp_rate,                  100,    1,     INT_MAX, },
	{ "monster_config/monster_hp_rate",                   &battle_config.monster_hp_rate,              100,    1,     INT_MAX, },
	{ "monster_config/monster_max_aspd",                  &battle_config.monster_max_aspd,             199,    100,   199,     },
	{ "monster_config/monster_ai",                        &battle_config.mob_ai,                       0x000,  0x000, 0x77F,   },
	{ "monster_config/monster_chase_refresh",             &battle_config.mob_chase_refresh,            1,      0,     30,      },
	{ "monster_config/mob_warp",                          &battle_config.mob_warp,                     0,      0,     1|2|4,   },
	{ "monster_config/mob_active_time",                   &battle_config.mob_active_time,              0,      0,     INT_MAX, },
	{ "monster_config/boss_active_time",                  &battle_config.boss_active_time,             0,      0,     INT_MAX, },
	{ "monster_config/view_range_rate",                   &battle_config.view_range_rate,              100,    0,     INT_MAX, },
	{ "monster_config/chase_range_rate",                  &battle_config.chase_range_rate,             100,    0,     INT_MAX, },
	{ "monster_config/monster_active_enable",             &battle_config.monster_active_enable,        1,      0,     1,       },
	{ "monster_config/override_mob_names",                &battle_config.override_mob_names,           0,      0,     2,       },
	{ "monster_config/monster_damage_delay_rate",         &battle_config.monster_damage_delay_rate,    100,    0,     INT_MAX, },
	{ "monster_config/monster_loot_type",                 &battle_config.monster_loot_type,            0,      0,     1,       },
	{ "monster_config/mob_skill_rate",                    &battle_config.mob_skill_rate,               100,    0,     INT_MAX, },
	{ "monster_config/mob_skill_delay",                   &battle_config.mob_skill_delay,              100,    0,     INT_MAX, },
	{ "monster_config/mob_count_rate",                    &battle_config.mob_count_rate,               100,    0,     INT_MAX, },
	{ "monster_config/mob_spawn_delay",                   &battle_config.mob_spawn_delay,              100,    0,     INT_MAX, },
	{ "monster_config/plant_spawn_delay",                 &battle_config.plant_spawn_delay,            100,    0,     INT_MAX, },
	{ "monster_config/boss_spawn_delay",                  &battle_config.boss_spawn_delay,             100,    0,     INT_MAX, },
	{ "monster_config/no_spawn_on_player",                &battle_config.no_spawn_on_player,           0,      0,     100,     },
	{ "monster_config/force_random_spawn",                &battle_config.force_random_spawn,           0,      0,     1,       },
	{ "monster_config/slaves_inherit_mode",               &battle_config.slaves_inherit_mode,          2,      0,     3,       },
	{ "monster_config/slaves_inherit_speed",              &battle_config.slaves_inherit_speed,         3,      0,     3,       },
	{ "monster_config/summons_trigger_autospells",        &battle_config.summons_trigger_autospells,   1,      0,     1,       },
	{ "monster_config/retaliate_to_master",               &battle_config.retaliate_to_master,          1,      0,     1,       },
	{ "monster_config/mob_changetarget_byskill",          &battle_config.mob_changetarget_byskill,     0,      0,     1,       },
	{ "monster_config/monster_class_change_full_recover", &battle_config.monster_class_change_recover, 1,      0,     1,       },
	{ "monster_config/show_mob_info",                     &battle_config.show_mob_info,                0,      0,     1|2|4,   },
	{ "monster_config/zeny_from_mobs",                    &battle_config.zeny_from_mobs,               0,      0,     1,       },
	{ "monster_config/mobs_level_up",                     &battle_config.mobs_level_up,                0,      0,     1,       },
	{ "monster_config/mobs_level_up_exp_rate",            &battle_config.mobs_level_up_exp_rate,       1,      1,     INT_MAX, },
	{ "monster_config/dynamic_mobs",                      &battle_config.dynamic_mobs,                 1,      0,     1,       },
	{ "monster_config/mob_remove_damaged",                &battle_config.mob_remove_damaged,           1,      0,     1,       },
	{ "monster_config/mob_remove_delay",                  &battle_config.mob_remove_delay,             60000,  1000,  INT_MAX, },
	{ "monster_config/mob_npc_event_type",                &battle_config.mob_npc_event_type,           1,      0,     1,       },
	...
	{ "monster_config/show_monster_hp_bar",               &battle_config.show_monster_hp_bar,          1,      0,     1,       },
	...
	{ "monster_config/boss_icewall_walk_block",           &battle_config.boss_icewall_walk_block,      0,      0,     255,     },
	{ "monster_config/monster_eye_range_bonus",           &battle_config.mob_eye_range_bonus,          0,      0,     10,      },

	// party
	{ "party_config/show_steal_in_same_party",    &battle_config.show_steal_in_same_party,      0,    0,   1,       },
	{ "party_config/party_update_interval",       &battle_config.party_update_interval,         1000, 100, INT_MAX, },
	{ "party_config/party_hp_mode",                &battle_config.party_hp_mode,                0,    0,   1,       },
	{ "party_config/show_party_share_picker",      &battle_config.party_show_share_picker,      1,    0,   1,       },
	{ "party_config/show_picker_item_type",        &battle_config.show_picker_item_type,        112,  0,   INT_MAX, },
	{ "party_config/party_item_share_type",        &battle_config.party_share_type,             0,    0,   1|2|3,   },
	{ "party_config/idle_no_share",                &battle_config.idle_no_share,                0,    0,   INT_MAX, },
	{ "party_config/party_even_share_bonus",       &battle_config.party_even_share_bonus,       0,    0,   INT_MAX, },
	{ "party_config/display_party_name",           &battle_config.display_party_name,           0,    0,   1,       },
	{ "party_config/party_change_leader_same_map", &battle_config.party_change_leader_same_map, 0,    0,   1,       },

	// Pet
	{ "pet_config/pet_catch_rate",               &battle_config.pet_catch_rate,               100,  0,  INT_MAX, },
	{ "pet_config/pet_rename",                   &battle_config.pet_rename,                   0,    0,  1,       },
	{ "pet_config/pet_friendly_rate",            &battle_config.pet_friendly_rate,            100,  0,  INT_MAX, },
	{ "pet_config/pet_hungry_delay_rate",        &battle_config.pet_hungry_delay_rate,        100,  10, INT_MAX, },
	{ "pet_config/pet_hungry_friendly_decrease", &battle_config.pet_hungry_friendly_decrease, 5,    0,  INT_MAX, },
	{ "pet_config/pet_equip_required",           &battle_config.pet_equip_required,           0,    0,  1,       },
	{ "pet_config/pet_attack_support",           &battle_config.pet_attack_support,           0,    0,  1,       },
	{ "pet_config/pet_damage_support",           &battle_config.pet_damage_support,           0,    0,  1,       },
	{ "pet_config/pet_support_min_friendly",     &battle_config.pet_support_min_friendly,     900,  0,  950,     },
	{ "pet_config/pet_equip_min_friendly",       &battle_config.pet_equip_min_friendly,       900,  0,  950,     },
	{ "pet_config/pet_status_support",           &battle_config.pet_status_support,           0,    0,  1,       },
	{ "pet_config/pet_support_rate",             &battle_config.pet_support_rate,             100,  0,  INT_MAX, },
	{ "pet_config/pet_attack_exp_to_master",     &battle_config.pet_attack_exp_to_master,     0,    0,  1,       },
	{ "pet_config/pet_attack_exp_rate",          &battle_config.pet_attack_exp_rate,          100,  0,  INT_MAX, },
	{ "pet_config/pet_lv_rate",                  &battle_config.pet_lv_rate,                  0,    0,  INT_MAX, },
	{ "pet_config/pet_max_stats",                &battle_config.pet_max_stats,                99,   0,  INT_MAX, },
	{ "pet_config/pet_max_atk1",                 &battle_config.pet_max_atk1,                 750,  0,  INT_MAX, },
	{ "pet_config/pet_max_atk2",                 &battle_config.pet_max_atk2,                 1000, 0,  INT_MAX, },
	{ "pet_config/pet_disable_in_gvg",           &battle_config.pet_no_gvg,                   0,    0,  1,       },
	{ "pet_config/enable_pet_autofeed",          &battle_config.feature_enable_pet_autofeed,  1,    0,  1,       },

	// Player
	{ "player_config/hp_rate",                     &battle_config.hp_rate,                     100,     1,      INT_MAX,                },
	{ "player_config/sp_rate",                     &battle_config.sp_rate,                     100,     1,      INT_MAX,                },
	{ "player_config/left_cardfix_to_right",       &battle_config.left_cardfix_to_right,       0,       0,      1,                      },
	{ "player_config/restart_hp_rate",             &battle_config.restart_hp_rate,             0,       0,      100,                    },
	{ "player_config/restart_sp_rate",             &battle_config.restart_sp_rate,             0,       0,      100,                    },
	{ "player_config/player_skillfree",            &battle_config.skillfree,                   0,       0,      1,                      },
	{ "player_config/player_skillup_limit",        &battle_config.skillup_limit,               1,       0,      1,                      },
	{ "player_config/quest_skill_learn",           &battle_config.quest_skill_learn,           0,       0,      1,                      },
	{ "player_config/quest_skill_reset",           &battle_config.quest_skill_reset,           0,       0,      1,                      },
	{ "player_config/basic_skill_check",           &battle_config.basic_skill_check,           1,       0,      1,                      },
	{ "player_config/player_invincible_time",      &battle_config.pc_invincible_time,          5000,    0,      INT_MAX,                },
	{ "player_config/fix_warp_hit_delay_abuse",    &battle_config.fix_warp_hit_delay_abuse,    0,       0,      1,                      },
	{ "player_config/natural_healhp_interval",     &battle_config.natural_healhp_interval,     6000,    NATURAL_HEAL_INTERVAL, INT_MAX  },
	{ "player_config/natural_healsp_interval",     &battle_config.natural_healsp_interval,     8000,    NATURAL_HEAL_INTERVAL, INT_MAX  },
	...
	{ "player_config/max_third_aspd",              &battle_config.max_third_aspd,              193,     100,    193,                    },
	...
	{ "player_config/max_parameter",               &battle_config.max_parameter,               99,      10,     99,                     },
	{ "player_config/max_third_parameter",         &battle_config.max_third_parameter,         130,     10,     130,                    },
	{ "player_config/max_extended_parameter",      &battle_config.max_extended_parameter,      125,     10,     125,                    },
	{ "player_config/max_summoner_parameter",      &battle_config.max_summoner_parameter,      120,     10,     120,                    },
	{ "player_config/max_baby_parameter",          &battle_config.max_baby_parameter,          80,      10,     80,                     },
	{ "player_config/max_baby_third_parameter",    &battle_config.max_baby_third_parameter,    117,     10,     117,                    },
	{ "player_config/max_def",                     &battle_config.max_def,                     99,      0,      INT_MAX,                },
	{ "player_config/over_def_bonus",              &battle_config.over_def_bonus,              0,       0,      1000,                   },
	{ "player_config/max_cart_weight",             &battle_config.max_cart_weight,             8000,    100,    1000000,                },
	{ "player_config/prevent_logout",              &battle_config.prevent_logout,              10000,   0,      60000,                  },
	{ "player_config/prevent_logout_trigger",      &battle_config.prevent_logout_trigger,      0xE,     0,      0xF,                    },
	{ "player_config/show_hp_sp_drain",            &battle_config.show_hp_sp_drain,            0,       0,      1,                      },
	{ "player_config/show_hp_sp_gain",             &battle_config.show_hp_sp_gain,             1,       0,      1,                      },
	{ "player_config/show_katar_crit_bonus",       &battle_config.show_katar_crit_bonus,       0,       0,      1,                      },
	{ "player_config/friend_auto_add",             &battle_config.friend_auto_add,             1,       0,      1,                      },
	{ "player_config/invite_request_check",        &battle_config.invite_request_check,        1,       0,      1,                      },
	{ "player_config/bone_drop",                   &battle_config.bone_drop,                   0,       0,      2,                      },
	...
	{ "player_config/idletime_criteria",           &battle_config.idletime_criteria,           0x25,    1,      INT_MAX,                },
	{ "player_config/costume_refine_def",          &battle_config.costume_refine_def,          1,       0,      1,                      },
	{ "player_config/shadow_refine_def",           &battle_config.shadow_refine_def,           1,       0,      1,                      },
	{ "player_config/shadow_refine_atk",           &battle_config.shadow_refine_atk,           1,       0,      1,                      },
	{ "player_config/player_warp_keep_direction",  &battle_config.player_warp_keep_direction,  0,       0,      1,                      },

	//Skill
	{ "skill_config/casting_rate",                 &battle_config.cast_rate,                    100,    0,      100,     },
	{ "skill_config/delay_rate",                   &battle_config.delay_rate,                   100,    0,      100,     },
	{ "skill_config/delay_dependon_dex",           &battle_config.delay_dependon_dex,           0,      0,      1,       },
	{ "skill_config/delay_dependon_agi",           &battle_config.delay_dependon_agi,           0,      0,      1,       },
	{ "skill_config/min_skill_delay_limit",        &battle_config.min_skill_delay_limit,        100,    10,     100,     },
	{ "skill_config/default_walk_delay",           &battle_config.default_walk_delay,           300,    0,      INT_MAX, },
	{ "skill_config/no_skill_delay",               &battle_config.no_skill_delay,               BL_MOB, BL_NUL, BL_ALL,  },
	{ "skill_config/castrate_dex_scale",           &battle_config.castrate_dex_scale,           150,    1,      INT_MAX, },
	{ "skill_config/vcast_stat_scale",             &battle_config.vcast_stat_scale,             530,    1,      INT_MAX, },
	{ "skill_config/skill_amotion_leniency",       &battle_config.skill_amotion_leniency,       90,     0,      300      },
	{ "skill_config/skill_delay_attack_enable",    &battle_config.sdelay_attack_enable,         0,      0,      1,       },
	{ "skill_config/skill_add_range",              &battle_config.skill_add_range,              0,      0,      INT_MAX, },
	{ "skill_config/skill_out_range_consume",      &battle_config.skill_out_range_consume,      1,      0,      1,       },
	{ "skill_config/skillrange_by_distance",       &battle_config.skillrange_by_distance,       BL_PC,  BL_NUL, BL_ALL,  },
	{ "skill_config/skillrange_from_weapon",       &battle_config.use_weapon_skill_range,       BL_NUL, BL_NUL, BL_ALL,  },
	{ "skill_config/skill_caster_check",           &battle_config.skill_caster_check,           1,      0,      1,       },
	{ "skill_config/clear_skills_on_death",        &battle_config.clear_unit_ondeath,           BL_NUL, BL_NUL, BL_ALL,  },
	{ "skill_config/clear_skills_on_warp",         &battle_config.clear_unit_onwarp,            BL_ALL, BL_NUL, BL_ALL,  },
	{ "skill_config/defunit_not_enemy",            &battle_config.defnotenemy,                  0,      0,      1,       },
	{ "skill_config/skill_min_damage",             &battle_config.skill_min_damage,             2|4,    0,      1|2|4,   },
	{ "skill_config/combo_delay_rate",             &battle_config.combo_delay_rate,             100,    0,      INT_MAX, },
	{ "skill_config/auto_counter_type",            &battle_config.auto_counter_type,            BL_ALL, BL_NUL, BL_ALL,  },
	{ "skill_config/skill_reiteration",            &battle_config.skill_reiteration,            BL_NUL, BL_NUL, BL_ALL,  },
	{ "skill_config/skill_nofootset",              &battle_config.skill_nofootset,              BL_PC,  BL_NUL, BL_ALL,  },
	{ "skill_config/gvg_traps_target_all",         &battle_config.vs_traps_bctall,              BL_PC,  BL_NUL, BL_ALL,  },
	{ "skill_config/traps_setting",                &battle_config.traps_setting,                0,      0,      1,       },
	{ "skill_config/summon_flora_setting",         &battle_config.summon_flora,                 1|2,    0,      1|2,     },
	{ "skill_config/song_timer_reset",             &battle_config.song_timer_reset,             0,      0,      1,       },
	{ "skill_config/skill_wall_check",             &battle_config.skill_wall_check,             1,      0,      1,       },
	{ "skill_config/player_cloak_check_type",      &battle_config.pc_cloak_check_type,          1,      0,      1|2|4,   },
	{ "skill_config/monster_cloak_check_type",     &battle_config.monster_cloak_check_type,     4,      0,      1|2|4,   },
	{ "skill_config/land_skill_limit",             &battle_config.land_skill_limit,             BL_ALL, BL_NUL, BL_ALL,  },
	{ "skill_config/display_skill_fail",           &battle_config.display_skill_fail,           2,      0,      1|2|4|8, },
	{ "skill_config/chat_warpportal",              &battle_config.chat_warpportal,              0,      0,      1,       },
	{ "skill_config/sense_type",                   &battle_config.estimation_type,              1|2,    0,      1|2,     },
	{ "skill_config/finger_offensive_type",        &battle_config.finger_offensive_type,        0,      0,      1,       },
	{ "skill_config/gx_allhit",                    &battle_config.gx_allhit,                    0,      0,      1,       },
	{ "skill_config/gx_disptype",                  &battle_config.gx_disptype,                  1,      0,      1,       },
	{ "skill_config/devotion_level_difference",    &battle_config.devotion_level_difference,    10,     0,      INT_MAX, },
	{ "skill_config/player_skill_partner_check",   &battle_config.player_skill_partner_check,   1,      0,      1,       },
	{ "skill_config/skill_removetrap_type",        &battle_config.skill_removetrap_type,        0,      0,      1,       },
	{ "skill_config/backstab_bow_penalty",         &battle_config.backstab_bow_penalty,         0,      0,      1,       },
	{ "skill_config/skill_steal_max_tries",        &battle_config.skill_steal_max_tries,        0,      0,      UCHAR_MAX},
	{ "skill_config/copyskill_restrict",           &battle_config.copyskill_restrict,           2,      0,      2,       },
	{ "skill_config/berserk_cancels_buffs",        &battle_config.berserk_cancels_buffs,        0,      0,      1,       },
	{ "skill_config/max_heal",                     &battle_config.max_heal,                     9999,   0,      INT_MAX, },
	{ "skill_config/max_heal_lv",                  &battle_config.max_heal_lv,                  11,     1,      INT_MAX, },
	{ "skill_config/skip_teleport_lv1_menu",       &battle_config.skip_teleport_lv1_menu,       0,      0,      1,       },
	{ "skill_config/allow_skill_without_day",      &battle_config.allow_skill_without_day,      0,      0,      1,       },
	{ "skill_config/allow_es_magic_player",        &battle_config.allow_es_magic_pc,            0,      0,      1,       },
	{ "skill_config/sg_miracle_skill_ratio",       &battle_config.sg_miracle_skill_ratio,       1,      0,      10000,   },
	{ "skill_config/sg_miracle_skill_duration",    &battle_config.sg_miracle_skill_duration,    3600000, 0,     INT_MAX, },
	{ "skill_config/sg_angel_skill_ratio",         &battle_config.sg_angel_skill_ratio,         10,     0,      10000,   },
	{ "skill_config/skill_add_heal_rate",          &battle_config.skill_add_heal_rate,          7,      0,      INT_MAX, },
	{ "skill_config/eq_single_target_reflectable", &battle_config.eq_single_target_reflectable, 1,      0,      1,       },
	{ "skill_config/invincible_nodamage",          &battle_config.invincible_nodamage,          0,      0,      1,       },
	{ "skill_config/dancing_weaponswitch_fix",     &battle_config.dancing_weaponswitch_fix,     1,      0,      1,       },
	{ "skill_config/skill_trap_type",              &battle_config.skill_trap_type,              0,      0,      1,       },
	{ "skill_config/trap_reflect",                 &battle_config.trap_reflect,                 1,      0,      1,       },
	{ "skill_config/mob_max_skilllvl",             &battle_config.mob_max_skilllvl,             100,    1,      INT_MAX, },
	{ "skill_config/bowling_bash_area",            &battle_config.bowling_bash_area,            0,      0,      20,      },
	{ "skill_config/stormgust_knockback",          &battle_config.stormgust_knockback,          1,      0,      1,       },
	{ "skill_config/magicrod_type",                &battle_config.magicrod_type,                0,      0,      1,       },
	{ "skill_config/skill_log",                    &battle_config.skill_log,                    BL_NUL, BL_NUL, BL_ALL,  },

	//Misc
	{ "misc_config/pk_mode",                    &battle_config.pk_mode,                          0,         0,    2,        },
	{ "misc_config/pk_min_level",               &battle_config.pk_min_level,                     55,        1,    INT_MAX,  },
	{ "misc_config/pk_level_range",             &battle_config.pk_level_range,                   0,         0,    INT_MAX,  },
	{ "misc_config/manner_system",              &battle_config.manner_system,                    0xFFF,     0,    0xFFF,    },
	{ "misc_config/battle_log",                 &battle_config.battle_log,                       0,         0,    1,        },
	{ "misc_config/etc_log",                    &battle_config.etc_log,                          1,         0,    1,        },
	{ "misc_config/warp_point_debug",           &battle_config.warp_point_debug,                 0,         0,    1,        },
	{ "misc_config/night_at_start",             &battle_config.night_at_start,                   0,         0,    1,        },
	{ "misc_config/day_duration",               &battle_config.day_duration,                     0,         0,    INT_MAX,  },
	{ "misc_config/night_duration",             &battle_config.night_duration,                   0,         0,    INT_MAX,  },
	{ "misc_config/duel_allow_pvp",             &battle_config.duel_allow_pvp,                   0,         0,    1,        },
	{ "misc_config/duel_allow_gvg",             &battle_config.duel_allow_gvg,                   0,         0,    1,        },
	{ "misc_config/duel_allow_teleport",        &battle_config.duel_allow_teleport,              0,         0,    1,        },
	{ "misc_config/duel_autoleave_when_die",    &battle_config.duel_autoleave_when_die,          1,         0,    1,        },
	{ "misc_config/duel_time_interval",         &battle_config.duel_time_interval,               60,        0,    INT_MAX,  },
	{ "misc_config/duel_only_on_same_map",      &battle_config.duel_only_on_same_map,            0,         0,    1,        },
	{ "misc_config/official_cell_stack_limit",  &battle_config.official_cell_stack_limit,        1,         0,    255,      },
	{ "misc_config/custom_cell_stack_limit",    &battle_config.custom_cell_stack_limit,          1,         1,    255,      },
	{ "misc_config/check_occupied_cells",       &battle_config.check_occupied_cells,             1,         0,    1,        },
	{ "misc_config/at_mapflag",                 &battle_config.autotrade_mapflag,                0,         0,    1,        },
	{ "misc_config/at_timeout",                 &battle_config.at_timeout,                       0,         0,    INT_MAX,  },
	{ "misc_config/searchstore_querydelay",     &battle_config.searchstore_querydelay,           10,        0,    INT_MAX,  },
	{ "misc_config/searchstore_maxresults",     &battle_config.searchstore_maxresults,           30,        1,    INT_MAX,  },
	{ "misc_config/cashshop_show_points",       &battle_config.cashshop_show_points,             0,         0,    1,        },
 ...
 */
static bool battle_config_read(const char *filename)
{
