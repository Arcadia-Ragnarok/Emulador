 ...
 */
static bool ipban_config_read_inter(const char *filename)
{
 ...
 * @retval false in case of error.
 */
static bool ipban_config_read_connection(const char *filename, struct config_t *config)
{
	struct config_setting_t *setting = NULL;
 ...
 * @retval false in case of error.
 */
static bool ipban_config_read_dynamic(const char *filename, struct config_t *config)
{
	struct config_setting_t *setting = NULL;
 ...
 * @retval false in case of error.
 */
static bool ipban_config_read(const char *filename, struct config_t *config)
{
	struct config_setting_t *setting = NULL;
	bool retval = true;
