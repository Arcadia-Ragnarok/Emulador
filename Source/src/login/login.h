...
struct login_interface {
	...
	bool (*config_read_inter) (const char *filename, struct config_t *config);
	bool (*config_read_console) (const char *filename, struct config_t *config);
	bool (*config_read_log) (const char *filename, struct config_t *config);
	bool (*config_read_account) (const char *filename, struct config_t *config);
	bool (*config_read_permission) (const char *filename, struct config_t *config);
	bool (*config_read_permission_hash) (const char *filename, struct config_t *config);
	bool (*config_read_permission_blacklist) (const char *filename, struct config_t *config);
	bool (*config_read_users) (const char *filename, struct config_t *config);
...
extern struct lchrif_interface *lchrif;
