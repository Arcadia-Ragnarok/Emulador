...
int read_mercenarydb(void) {
	...
	sv->readdb(map->db_path, "Summon_DB/Mercenary.txt", ',', 26, 26, MAX_MERCENARY_CLASS, mercenary->read_db_sub);
...
int read_mercenary_skilldb(void) {
	sv->readdb(map->db_path, "Summon_DB/MercSkill.txt", ',', 3, 3, -1, mercenary->read_skill_db_sub);
