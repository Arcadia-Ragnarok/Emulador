...
ìƒíƒœìºë¦­í„° ì¤‘ëŸ‰ì´ˆê³¼ë¡œ ì˜¬ë ¤ë†“ì„ìˆ˜ê°€ ì—†ìŠµë‹ˆë‹¤.
20110706 to latest
...
ëˆì´ ë¶€ì¡±í•´ì„œ ìŠ¤í‚¬ì„ ì“¸ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20111017 to latest
...
[EVENT] ì´ë²¤íŠ¸ì— ë‹¹ì²¨ë˜ì…¨ìŠµë‹ˆë‹¤. ê²Œìž„ë‚´ì—ì„œ ì•„ì´í…œì„ ì§€ê¸‰ë°›ìœ¼ì‹­ì‹œìš”.
20110531 to latest
...
'%s'ë¥¼ ê°œë´‰ í•˜ì‹œê² ìŠµë‹ˆê¹Œ?  í•œë²ˆ ê°œë´‰ëœ ì•„ì´í…œì€ ì°½ê³  ì €ìž¥ ì™¸ì˜ ë‹¤ë¥¸ ì´ë™ì€ ë¶ˆê°€í•˜ë©° ìž„ëŒ€ ì•„ì´í…œì€ ì°½ê³  ì €ìž¥ë„ ë¶ˆê°€í•©ë‹ˆë‹¤. í•œì • ì•„ì´í…œì€ ê±°ëž˜ ë° ì´ë™ì´ ê°€ëŠ¥ í•©ë‹ˆë‹¤. ë™ì¼í•œ ì•„ì´í…œì„ ì¤‘ë³µ ì‚¬ìš©í•˜ë”ë¼ë„ íš¨ê³¼ê°€ ì¤‘ì²©ë˜ì§€ ì•ŠìŠµë‹ˆë‹¤.
20101102 to 20110330
'%s'ë¥¼ ê°œë´‰ í•˜ì‹œê² ìŠµë‹ˆê¹Œ?  ^ff0000ìƒìžë¥¼ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ë° í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ ë©ë‹ˆë‹¤.^000000 í•œë²ˆ ê°œë´‰ ëœ ì•„ì´í…œì€ ì°½ê³  ì €ìž¥ ì™¸ì˜ ë‹¤ë¥¸ ì´ë™ì€ ë¶ˆê°€í•˜ë©° ìž„ëŒ€ ì•„ì´í…œì€ ì°½ê³  ì €ìž¥ë„ ë¶ˆê°€í•©ë‹ˆë‹¤. í•œì • ì•„ì´í…œì€ ê±°ëž˜ ë° ì´ë™ì´ ê°€ëŠ¥ í•©ë‹ˆë‹¤. ë™ì¼í•œ ì•„ì´í…œì„ ì¤‘ë³µ ì‚¬ìš©í•˜ë”ë¼ë„ íš¨ê³¼ê°€ ì¤‘ì²©ë˜ì§€ ì•ŠìŠµë‹ˆë‹¤.
20110405 to latest
...
/*20080827 to 20111021
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” ê²½í—˜ì¹˜ê°€ 30ë¶„ê°„ 1.5ë°°ë¡œ ì¦ê°€í•©ë‹ˆë‹¤.
20111025 to 20111101
 30ë¶„ê°„ ì–»ì„ ìˆ˜ ìžˆëŠ” ê²½í—˜ì¹˜ê°€ 75%% ì¦ê°€í•©ë‹ˆë‹¤.
20111102 to latest
...
/*20080827 to 20100629
 ë³¸ ì•„ì´í…œì€ ì²­ì•½ ì² íšŒë‚˜ í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ë˜ëŠ” ì•„ì´í…œìž…ë‹ˆë‹¤. ì •ë§ë¡œ '%s'ì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ?, %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20100701 to 20101026
 ë³¸ ì•„ì´í…œì€ ì²­ì•½ ì² íšŒë‚˜ í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ë˜ëŠ” ì•„ì´í…œìž…ë‹ˆë‹¤. ì •ë§ë¡œ %sì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ?, %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20101102 to 20101130
 ^ff0000ë³¸ ì•„ì´í…œì„ êµ¬ë§¤ í›„ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ë° í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ ë©ë‹ˆë‹¤.^000000 ì •ë§ë¡œ %sì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ? êµ¬ë§¤í•˜ì‹¤ ê²½ìš° %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20101207 to 20110330
 ^ff0000ë³¸ ì•„ì´í…œì„ êµ¬ë§¤ í›„ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ë° í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ ë©ë‹ˆë‹¤.^000000 ì •ë§ë¡œ ì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ? êµ¬ë§¤í•˜ì‹¤ ê²½ìš° %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20110405 to 20120618
 ^ff0000ë³¸ ì•„ì´í…œì„ êµ¬ë§¤ í›„ 7ì¼ ì´ë‚´ì—ëŠ” ì²­ì•½ ì² íšŒê°€ ê°€ëŠ¥í•©ë‹ˆë‹¤. ë‹¤ë§Œ, 7ì¼ì´ ì§€ë‚¬ê±°ë‚˜ ì•„ì´í…œì„ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ëŒ€ìƒì—ì„œ ì œì™¸ ë©ë‹ˆë‹¤.^000000 ì •ë§ë¡œ ì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ? êµ¬ë§¤í•˜ì‹¤ ê²½ìš° %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20120626 to latest
...
/*20080827 to 20100629
 ë³¸ ì•„ì´í…œì€ ì²­ì•½ ì² íšŒë‚˜ í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ë˜ëŠ” ì•„ì´í…œìž…ë‹ˆë‹¤. ì •ë§ë¡œ '%s'ì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ?, ì¼ë°˜ %dìºì‹œ, ë¬´ë£Œ %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20100701 to 20101026
 ë³¸ ì•„ì´í…œì€ ì²­ì•½ ì² íšŒë‚˜ í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ë˜ëŠ” ì•„ì´í…œìž…ë‹ˆë‹¤. ì •ë§ë¡œ %sì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ?, ì¼ë°˜ %dìºì‹œ, ë¬´ë£Œ %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20101102 to 20101130
 ^ff0000ë³¸ ì•„ì´í…œì„ êµ¬ë§¤ í›„ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ë° í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ë©ë‹ˆë‹¤.^000000 ì •ë§ë¡œ %sì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ? êµ¬ë§¤í•˜ì‹¤ ê²½ìš° ì¼ë°˜ %dìºì‹œ, ë¬´ë£Œ %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20101207 to 20110330
 ^ff0000ë³¸ ì•„ì´í…œì„ êµ¬ë§¤ í›„ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ë° í™˜ë¶ˆ ëŒ€ìƒì—ì„œ ì œì™¸ë©ë‹ˆë‹¤.^000000 ì •ë§ë¡œ ì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ? êµ¬ë§¤í•˜ì‹¤ ê²½ìš° ì¼ë°˜ %dìºì‹œ, ë¬´ë£Œ %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20110405 to 20120618
 ^ff0000ë³¸ ì•„ì´í…œì„ êµ¬ë§¤ í›„ 7ì¼ ì´ë‚´ì—ëŠ” ì²­ì•½ ì² íšŒê°€ ê°€ëŠ¥í•©ë‹ˆë‹¤. ë‹¤ë§Œ, 7ì¼ì´ ì§€ë‚¬ê±°ë‚˜ ì•„ì´í…œì„ ê°œë´‰í•˜ì‹œë©´ ì²­ì•½ ì² íšŒ ëŒ€ìƒì—ì„œ ì œì™¸ ë©ë‹ˆë‹¤.^000000 ì •ë§ë¡œ ì•„ì´í…œì„ êµ¬ë§¤í•˜ì‹œê² ìŠµë‹ˆê¹Œ? êµ¬ë§¤í•˜ì‹¤ ê²½ìš° ì¼ë°˜ %dìºì‹œ, ë¬´ë£Œ %dìºì‹œê°€ ì°¨ê°ë©ë‹ˆë‹¤.
20120626 to latest
...
ë¶ˆë²•í”„ë¡œê·¸ëž¨ì„ ì‚¬ìš©í•˜ì˜€ê±°ë‚˜ í•´í‚¹ì„ ì‹œë„í•œ ê³„ì •ì´ê±°ë‚˜ ê·¸ë¼ë¹„í‹° ì´ì „ì„ ì‹ ì²­í•œ í•œê²Œìž„ ê³„ì •ìž…ë‹ˆë‹¤.  ë¸”ëŸ­ì¢…ë£Œì‹œê°„ : %s
*/
	MSG_RE17 = 0x564,
/*20080827 to latest
...
/*20080827 to 20100721
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” Jobê²½í—˜ì¹˜ê°€ 30ë¶„ê°„ 1.5ë°°ë¡œ ì¦ê°€í•©ë‹ˆë‹¤.
20100727 to latest
...
/*20080827 to 20091110
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” ê²½í—˜ì¹˜ê°€ 30ë¶„ê°„ 1.25ë°°ë¡œ ì¦ê°€í•©ë‹ˆë‹¤.
20091117 to latest
...
ì†Œí™˜ëœ êµ¬ì²´ê°€ ì¡´ìž¬í•˜ì§€ ì•ŠìŠµë‹ˆë‹¤.
20130717 to latest
...
ìƒì„± ê°€ëŠ¥ ìºë¦­í„° ìˆ˜ëŠ” 9ê°œìž…ë‹ˆë‹¤!!(ìž„ì‹œ)
20090226 to latest
...
ì „ìž¥ - [%s] ìž…ìž¥ ì‹ ì²­ì´ ì™„ë£Œë˜ì—ˆìŠµë‹ˆë‹¤.
20090722 to 20090929
ìž…ìž¥ ì‹ ì²­ì´ ì™„ë£Œë˜ì—ˆìŠµë‹ˆë‹¤.
...
ì „ìž¥ - [%s] ìž…ìž¥ í•˜ì‹¤ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20090701 to 20090715
ì „ìž¥ - [%s] ì— ìž…ìž¥ í•  ìˆ˜ ì—†ëŠ” ìƒíƒœì´ë¯€ë¡œ ë“±ë¡ì´ ì·¨ì†Œ ë˜ì—ˆìŠµë‹ˆë‹¤.
20090722 to 20090929
ì— ìž…ìž¥ í•  ìˆ˜ ì—†ëŠ” ìƒíƒœì´ë¯€ë¡œ ë“±ë¡ì´ ì·¨ì†Œ ë˜ì—ˆìŠµë‹ˆë‹¤.
20091006 to latest
...
/*20090617 to 20090929
ìž…ìž¥ ì‹ ì²­ì„ ì·¨ì†Œí•˜ì‹œê² ìŠµë‹ˆê¹Œ?
20091006 to 20100616
%s ì „ìž¥ ì‹ ì²­ì„ ì •ë§ë¡œ ì·¨ì†Œí•˜ì‹œê² ìŠµë‹ˆê¹Œ?
20100622 to latest
...
/*20090617 to 20090715
ì „ìž¥ - [%s] ìž…ìž¥ ì‹ ì²­ì´ ì·¨ì†Œë˜ì—ˆìŠµë‹ˆë‹¤.
20090722 to 20090929
ìž…ìž¥ ì‹ ì²­ì´ ì·¨ì†Œë˜ì—ˆìŠµë‹ˆë‹¤.
20091006 to latest
...
/*20090701 to 20090715
ì „ìž¥ - [%s] : ì‹œìŠ¤í…œ ì˜¤ë¥˜ë¡œ ìž…ìž¥ í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20090722 to latest
...
/*20090701 to 20090715
ì „ìž¥ - [%s] : ëŒ€ê¸° ì¸ì› ìˆ˜ ì´ˆê³¼ë¡œ ìž…ìž¥ í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20090722 to latest
...
/*20090701 to 20090715
ì „ìž¥ - [%s] : ëŒ€ê¸° ì‹œê°„ì´ ì´ˆê³¼ë˜ì–´ ë“±ë¡ì´ ì·¨ì†Œ ë˜ì—ˆìŠµë‹ˆë‹¤.
20090722 to latest
...
/*20090701 to 20090715
ì „ìž¥ - [%s] : ìž…ìž¥ ì¡°ê±´ì´ ë§žì§€ ì•Šì•„, ë“±ë¡ì´ ì·¨ì†Œ ë˜ì—ˆìŠµë‹ˆë‹¤.
20090722 to latest
...
/*20090701 to 20090715
ì „ìž¥ - [%s] : ì˜¤ë¥˜ê°€ ë°œìƒí•˜ì—¬ ë“±ë¡ì´ ì·¨ì†Œ ë˜ì—ˆìŠµë‹ˆë‹¤.
20090722 to latest
...
/*20091103 to 20091104
 [%s]ê°€ [%s](ìœ¼)ë¡œë¶€í„° '%d'ì˜ ë°ë¯¸ì§€ë¥¼ ë°›ì•˜ìŠµë‹ˆë‹¤.
20091110 to latest
...
/*20091103 to 20091104
 [%së‹˜]ê°€ [%s]ì—ê²Œ '%d'ì˜ ë°ë¯¸ì§€ë¥¼ ì£¼ì—ˆìŠµë‹ˆë‹¤.
20091110 to latest
...
ì´ êµ¬ë§¤ ê°€ëŠ¥ ê°œìˆ˜ëŠ” %dê°œ ìž…ë‹ˆë‹¤.
20100209 to latest
...
/*20100406 to 20100414
ê°€ê²©ì´ 0 Zenyì¸ ì•„ì´í…œì´ ì¡´ìž¬í•©ë‹ˆë‹¤. ê°€ê²©ì„ ìž…ë ¥í•´ ì£¼ì„¸ìš”.
20100420 to latest
...
/*20100406 to 20100414
ê°€ê²©ì´ 9999ë§Œ Zenyì´ìƒì¸ ì•„ì´í…œì´ ì¡´ìž¬í•©ë‹ˆë‹¤. 9999ë§Œ Zeny ì´í•˜ì˜ ê°€ê²©ì„ ìž…ë ¥í•´ ì£¼ì„¸ìš”.
20100420 to latest
ë‚˜ì˜ êµ¬ë§¤ë…¸ì 
Purchase list:
*/
...
/*20100406 to 20100414
êµ¬ë§¤ìˆ˜ëŸ‰ì´ 0 ê°œì¸ ì•„ì´í…œì´ ì¡´ìž¬í•©ë‹ˆë‹¤. ìˆ˜ëŸ‰ì„ ìž…ë ¥í•´ ì£¼ì„¸ìš”.
...
/*20100406 to 20100414
êµ¬ë§¤ìˆ˜ëŸ‰ì´ 9999ê°œ ì´ìƒì¸ ì•„ì´í…œì´ ì¡´ìž¬í•©ë‹ˆë‹¤. 9999ê°œ ì´í•˜ì˜ ìˆ˜ëŸ‰ì„ ìž…ë ¥í•´ ì£¼ì„¸ìš”.
20100420 to latest
%s %s Zeny %d ê°œ
Buying %s for %s Zeny. Amount: %d.
*/
...
/*20100406 to 20100414
êµ¬ë§¤ìƒì  ì—´ê¸°ì— ì‹¤íŒ¨í–ˆìŠµë‹ˆë‹¤.
20100420 to latest
íŒë§¤ ê°€ëŠ¥í•œ ì•„ì´í…œ ëª©ë¡
Available items:
*/
...
/*20100406 to 20100414
êµ¬ë§¤ê°€ëŠ¥í•œ ìµœëŒ€ ê°¯ìˆ˜ë¥¼ ì´ˆê³¼í•˜ì˜€ìŠµë‹ˆë‹¤.
20100420 to 20110208
êµ¬ë§¤ìžì˜ ìž”ì•¡ì´ ë¶€ì¡±í•˜ë‹ˆ ë‹¤ì‹œ ì„¤ì •í•´ ì£¼ì„¸ìš”
20110215 to latest
...
/*20100406 to 20100414
ë‚¨ì€ ìž”ì•¡ìœ¼ë¡œ ì•„ì´í…œ êµ¬ë§¤ê°€ ë¶ˆê°€ëŠ¥ í•©ë‹ˆë‹¤.
20100420 to latest
...
ìƒì  ì •ë³´ê°€ ì •í™•í•˜ì§€ ì•Šì•„ ìƒì ì„ ì—´ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20100629 to latest
...
ìƒëŒ€ë°©ì—ê²Œ ì œë‹ˆ ì§€ê¸‰ì— ì‹¤íŒ¨í–ˆìŠµë‹ˆë‹¤.
20130515 to latest
...
ë¹„ë°€ë²ˆí˜¸ëŠ” 4ìžë¦¬ ì´ìƒ 6ìžë¦¬ì´í•˜ì—¬ì•¼ë§Œ í•©ë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ íŒ¨ìŠ¤ì›Œë“œì˜ ìƒì„±ì— ì„±ê³µí–ˆìŠµë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ íŒ¨ìŠ¤ì›Œë“œë¥¼ ì‚­ì œí–ˆìŠµë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ íŒ¨ìŠ¤ì›Œë“œë¥¼ ìˆ˜ì •í–ˆìŠµë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ íŒ¨ìŠ¤ì›Œë“œì˜ ìƒì„±ì— ì‹¤íŒ¨í–ˆìŠµë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ íŒ¨ìŠ¤ì›Œë“œ ì‚­ì œì— ì‹¤íŒ¨í–ˆìŠµë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ íŒ¨ìŠ¤ì›Œë“œì˜ ìˆ˜ì •ì— ì‹¤íŒ¨í–ˆìŠµë‹ˆë‹¤.
20110308 to latest
...
/*20110228 to 20110228
ì„¸ì»¨ë“œ ë¹„ë°€ë²ˆí˜¸ì—ëŠ” ì œí•œëœ ë²ˆí˜¸ë¥¼ ì‚¬ìš©í• ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20110308 to latest
...
[ìˆ˜í˜¸ ì²œì‚¬ì˜ ë³´í˜¸] ìŠ¤í‚¬ì€ ë§Œë ™ì¼ ê²½ìš°, ê²½í—˜ì¹˜ 100% ì´ìƒì¼ ë•ŒëŠ” ì‚¬ìš©í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20111004 to latest
...
ì²­ì†Œë…„ ë³´í˜¸ë²•ì— ë”°ë¼, ìž ì‹œ í›„ 0ì‹œ ë¶€í„° 6ì‹œ ê¹Œì§€ ^ff0000ë§Œ 16ì„¸ ë¯¸ë§Œ ê³ ê°ë‹˜ë“¤ì˜ ê²Œìž„ ì´ìš©ì´ ì œí•œ^000000ë©ë‹ˆë‹¤.
20111122 to latest
...
/*20111017 to 20111021
ë”ì´ìƒ íƒ­ì„ ì œê±°í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20111025 to latest
...
/*20111017 to 20111021
ë”ì´ìƒ íƒ­ì„ ì¶”ê°€í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20111025 to latest
...
/*20111114 to 20111116
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” ê²½í—˜ì¹˜ê°€ %dë¶„ê°„ %d%% ì¦ê°€í•©ë‹ˆë‹¤.
20111122 to latest
...
íŒŒí‹° ê´‘ê³ ë¥¼ ë“±ë¡í•˜ê¸° ìœ„í•´ 1000ì œë‹ˆê°€ ì†Œëª¨ë©ë‹ˆë‹¤.
20120214 to latest
...
íŒŒí‹°ìž¥ì´ ìžˆëŠ” ë§µì—ì„œëŠ” ì†Œí™˜ì´ ì•ˆë©ë‹ˆë‹¤.
20120307 to latest
...
/*20120417 to 20120418
-> ë§µì´ë¦„, ìœ„ì¹˜(100 90), scrool/ zeny/ plane (1:ì‚¬ìš©í•¨ 0: ì‚¬ìš©ì•ˆí•¨)
20120424 to latest
...
/*20120417 to 20120418
â€» /navi2 ì˜ ê²½ìš° ë°˜ë“œì‹œ ìœ„ì¹˜ ì¢Œí‘œë¥¼ ë¶™ì—¬ì„œ 3 ìžë¦¬ë¡œ ì ì–´ì•¼ í•œë‹¤
20120424 to latest
...
%.3f%% (PCë°© %.3f%% + TPLUS %.3f%% + í”„ë¦¬ë¯¸ì—„ %.3f%% + %sì„œë²„ %.3f%%)
20120601 to latest
...
/bufftimer : ë²„í”„ì— ì¿¨íƒ€ì´ë¨¸ë¥¼ í‘œì‹œí•©ë‹ˆë‹¤. On Off
20120830 to latest
ì„±ë³„ ì„ íƒ ì°½
...
/*20120724 to 20120822
ë²„í”„ì— ì¿¨íƒ€ì´ë¨¸ê°€ í‘œì‹œë˜ì§€ ì•ŠìŠµë‹ˆë‹¤.
20120830 to latest
...
ë³´ìœ  Zeny ëŠ” 21 ì–µì„ ë„˜ì„ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20130605 to latest
...
* ìµœëŒ€ 21ì–µ Zenyê¹Œì§€ë§Œ ë³´ê´€ì´ ê°€ëŠ¥í•©ë‹ˆë‹¤.
20130522 to 20130529
ìµœëŒ€ 2,147,483,647ì–µ Zenyê¹Œì§€ë§Œ ë³´ê´€ì´ ê°€ëŠ¥í•©ë‹ˆë‹¤.
20130605 to 20130605
ìµœëŒ€ 2,147,483,647 Zenyê¹Œì§€ë§Œ ë³´ê´€ì´ ê°€ëŠ¥í•©ë‹ˆë‹¤.
20130612 to latest
...
/*20130618 to 20130925
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” ê¸°ë³¸ ì•„ì´í…œì˜ ë“œë¡­ë¥ ì´ %dë¶„ê°„ %dë°°ë¡œ ì¦ê°€í•©ë‹ˆë‹¤.
20130807 to 20130814
%d%% ( Basic 100%% + Premium %d%% + PCCafe %d%% + %s Server %d%% )
%d%% ( Basic 100%% + Premium %d%% + Internet cafe %d%% + %s Server %d%% )
20130925 to latest
...
/*20130618 to 20130925
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” ê¸°ë³¸ ì•„ì´í…œì˜ ë“œë¡­ë¥ ì´ %dì‹œ %.2dë¶„ê°„ %dë°°ë¡œ ì¦ê°€í•©ë‹ˆë‹¤.
20130807 to 20130814
 ëª¬ìŠ¤í„° ì‚¬ëƒ¥ì„ í†µí•´ ì–»ì„ ìˆ˜ ìžˆëŠ” ê¸°ë³¸ ì•„ì´í…œì˜ ë“œë¡­ë¥ ì´ %dë¶„ê°„ %dë°°ë¡œ ì¦ê°€í•©ë‹ˆë‹¤.
20130925 to latest
...
ê¸¸ë“œ ì°½ê³ ë¥¼ ì´ìš©í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤. ìž ì‹œ í›„ ì´ìš©í•´ì£¼ì„¸ìš”.
20130917 to latest
...
ê¸¸ë“œì°½ê³ ì˜ ì‚¬ìš© ê¶Œí•œì´ ì—†ìŠµë‹ˆë‹¤. ê¸¸ë“œ ë§ˆìŠ¤í„°ì—ê²Œ ìš”ì²­í•˜ì„¸ìš”.
20130904 to latest
...
ì§„í™”ê°€ ë¶ˆê°€ëŠ¥í•œ ìš”ì²­ìž…ë‹ˆë‹¤.
20140212 to latest
...
ì œëª©ì˜ ê¸¸ì´ëŠ” 4ìžì´ìƒ ì´ì–´ì•¼ í•©ë‹ˆë‹¤.
20140423 to 20141001
ì œëª©ì˜ ê¸¸ì´ëŠ” 4ìžì´ìƒ 16ìž ì´í•˜ì—¬ì•¼ í•©ë‹ˆë‹¤.
20141008 to latest
...
ìˆ˜ì‹ ìžì˜ ë©”ì¼ ë³´ê´€ ìš©ëŸ‰ì´ ì´ˆê³¼ë˜ì—ˆìŠµë‹ˆë‹¤.
20140423 to latest
...
ë³´ìœ  ê°€ëŠ¥í•œ ìµœëŒ€ ë§ˆì¼ë¦¬ì§€ : %d 
20140605 to latest
...
/*20140521 to 20140521
ì•„ì´í…œ íŽ¸ì§€ ë³´ë‚´ê¸°ê°€ ë¶ˆ ê°€ëŠ¥í•œ ì„œë²„ ìž…ë‹ˆë‹¤.
20140528 to latest
ì•„ì´í…œ ë²„ë¦¬ê¸°ê°€ ë¶ˆ ê°€ëŠ¥í•œ ì„œë²„ ìž…ë‹ˆë‹¤.
Items discard is imposible in server.
*/
...
/*20140618 to 20140924
í™˜ìƒì˜ ë£°ë ›ì°½ì„ ë‹«ì„ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20141001 to latest
...
/*20140618 to 20140924
í™˜ìƒì˜ ë£°ë ›ì„ ì‹œìž‘ í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20141001 to latest
...
/*20140618 to 20140924
í™˜ìƒì˜ ë£°ë ›ì„ ì‹œìž‘í•˜ê¸° ìœ„í•´ì„œëŠ” í¬ì¸íŠ¸ê°€ í•„ìš”í•©ë‹ˆë‹¤.
20141001 to latest
...
2147483647 Zeny ì´í•˜ë¡œ ìž…ë ¥ í•˜ì‹­ì‹œì˜¤.
20150325 to latest
...
ì¿ í° ì—†ìŒ, ìƒì ì—ì„œ êµ¬ë§¤í•´ì•¼í•´ìš”.
20151202 to latest
...
*/
	MSG_ID_AFE = 0xafe,
/*20151028 to 20151125
ì•„ì´í…œì°½ì˜ ì¿ í° ìƒìžë¥¼ ì—´ì–´ì£¼ì„¸ìš”
20151202 to latest
...
*/
	MSG_ID_B00 = 0xb00,
/*20151028 to 20151125
ìŠ¬ë¡¯ì´ ê½‰ ì°¼ìŠµë‹ˆë‹¤. ìºë¦­í„°ë¥¼ ì‚­ì œ í›„ ì‚¬ìš©í•´ ì£¼ì‹œê¸° ë°”ëžë‹ˆë‹¤
20151202 to latest
...
*/
	MSG_ID_B01 = 0xb01,
/*20151028 to 20151125
ì‚¬ìš©í•˜ì‹  ì•„ì´í…œì€ ë˜ëŒë¦´ ìˆ˜ ì—†ìŠµë‹ˆë‹¤. ì ìš©í•˜ì‹œê² ìŠµë‹ˆê¹Œ?
20151202 to latest
...
ê´€ì‹¬ ìŠ¤íƒ€ì¼ë¡œ ë“±ë¡ë˜ì—ˆìŠµë‹ˆë‹¤
20151202 to latest
...
*/
	MSG_ID_B03 = 0xb03,
/*20151104 to 20151125
ì€í–‰ì— ì¶©ë¶„í•œ ì œë‹ˆê°€ ìžˆìŠµë‹ˆë‹¤. ë¨¼ì € ì€í–‰ìœ¼ë¡œ ê°€ì„¸ìš”.
20151202 to latest
...
ê°œì¸ ë¹„ê³µì • ì´ìš©ì— í•„ìš”í•œ í†µì¡°ë¦¼ì´ ë¶€ì¡±í•©ë‹ˆë‹¤.
20170927 to latest
...
*/
	MSG_ID_B11 = 0xb11,
/*20151125 to 20151125
ì—¼ìƒ‰ì„ í•  ìˆ˜ ì—†ëŠ” ë¨¸ë¦¬ìŠ¤íƒ€ì¼ìž…ë‹ˆë‹¤.
20151202 to latest
...
*/
	MSG_ID_B12 = 0xb12,
/*20151125 to 20151125
í™”ì‚´í‘œë¥¼ ëˆŒëŸ¬ ë§ˆìŒì— ë“œëŠ” ìŠ¤íƒ€ì¼ì„ ì„ íƒí•  ìˆ˜ ìžˆì–´ìš”.
20151202 to latest
...
ìŠ¤íƒ€ì¼ ìƒˆë¡œìš´ ìŠ¤íƒ€ì¼ì„ í™•ì¸í•´ ë³´ì„¸ìš”.
...
ë³€ê²½ëœ ìºë¦­ëª… %s ë¡œ ì „ì†¡í–ˆìŠµë‹ˆë‹¤. í™•ì¸ ë°”ëžë‹ˆë‹¤
20160406 to latest
...
êµ¬ìž…í•œ ë¬¼ê±´ì´ ë¡œë±ìŠ¤ë¡œ ë°°ì†¡ë˜ì—ˆìŠµë‹ˆë‹¤.
20160803 to latest
...
%sì€(ëŠ”) í˜„ìž¬ í˜¸ì¶œì„ ì°¨ë‹¨í•œ ìƒíƒœìž…ë‹ˆë‹¤.
20160928 to latest
...
ì œë ¨ ì¤‘ì—ëŠ” ì€í–‰ì„ ì‚¬ìš©í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤. ë¡œë±ìŠ¤ë¥¼ ê°•ì œ ì¢…ë£Œí•˜ì˜€ìŠµë‹ˆë‹¤.
20161116 to latest
%Y.%m.%d
*/
	MSG_ID_BC3 = 0xbc3,
...
ìœ„ì¹˜ ê°’ì€ ìŒìˆ˜ ê°’ì´ ë“¤ì–´ ì˜¬ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.
20170405 to latest
...
10,001 z ~ 100,000 z
 = ìˆ˜ìˆ˜ë£Œìœ¨ : ^1567fe2%^000000
100,001 z ~ 1,000,000 z
 = ìˆ˜ìˆ˜ë£Œìœ¨ : ^1567fe4%^000000
1,000,001 z ~ 10,000,000 z
	 = ìˆ˜ìˆ˜ë£Œìœ¨ : ^1567fe6%^000000
10,000,001 z ~ 100,000,000 z
 = ìˆ˜ìˆ˜ë£Œìœ¨ : ^1567fe8%^000000
100,000,001 z ì´ìƒ
 = ìˆ˜ìˆ˜ë£Œìœ¨ : ^1567fe10%^000000
20170524 to latest
^b- ë…¸ì  ìˆ˜ìˆ˜ë£Œ ì•ˆë‚´^/b
ë…¸ì  ì„¤ì • ê°€ê²©ì— ë”°ë¼ ì¼ì • ë¹„ìœ¨ì˜ ìˆ˜ìˆ˜ë£Œê°€ ë¶€ê°€ë©ë‹ˆë‹¤.
...
ì œë ¨ìž¬ë£Œê°€ ë³€ê²½ë˜ì–´ ë‹¤ì‹œí•˜ê¸°ê°€ ë¹„í™œì„±í™” ë˜ì—ˆìŠµë‹ˆë‹¤.
20170816 to latest
...
íŒŒí‹° ëª¨ì§‘ ì¤‘ë‹¨ì— ì‹¤íŒ¨í–ˆìŠµë‹ˆë‹¤.
20180418 to latest
...
*/
	MSG_ID_DB5 = 0xdb5,
/*20180418 to 20180418
%s : ì‹œì•¼í™•ìž¥ì„ ì¼œê±°ë‚˜ ëŒìˆ˜ ìžˆìŠµë‹ˆë‹¤ On Off
20180425 to latest
%s : Zoom Outì„ ì¼œê±°ë‚˜ ëŒìˆ˜ ìžˆìŠµë‹ˆë‹¤ On Off
*/
	MSG_ID_DB6 = 0xdb6,
/*20180418 to 20180418
ì‹œì•¼ë¥¼ í™•ìž¥í•©ë‹ˆë‹¤(On)
20180425 to latest
