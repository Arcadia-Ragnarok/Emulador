...
int64 battle_calc_damage(struct block_list *src,struct block_list *bl,struct Damage *d,int64 damage,uint16 skill_id,uint16 skill_lv) {
	...
	if( sc && sc->count )
	{
		...
		if(sc->data[SC_DEFENDER] &&
			((flag&(BF_LONG|BF_WEAPON)) == (BF_LONG|BF_WEAPON) || skill_id == CR_ACIDDEMONSTRATION)) damage = damage * ( 100 - sc->data[SC_DEFENDER]->val2 ) / 100;
...
#define GET_NORMAL_ATTACK2( f , s ) ( wd.damage2 = battle->calc_base_damage(src, target, s, skill_lv, nk, n_ele, s_ele, s_ele_, EQI_HAND_L, (f), wd.flag) )
		switch (skill_id) {
			...
			default:
			{
				i = (flag.cri || (sc && sc->data[SC_MAXIMIZEPOWER])?1:0)|
					(flag.arrow?2:0)|
...
battle_data[] = {
	...
	{ "drops_config/item_drop_common_max",     &battle_config.item_drop_common_max,     1000,  1,    1000,    },
	{ "drops_config/item_drop_equip_min",      &battle_config.item_drop_equip_min,      1,     1,    1000,    },
	{ "drops_config/item_drop_equip_max",      &battle_config.item_drop_equip_max,      1000,  1,    1000,    },
	{ "drops_config/item_drop_card_min",       &battle_config.item_drop_card_min,       1,     1,    1000,    },
	{ "drops_config/item_drop_card_max",       &battle_config.item_drop_card_max,       1000,  1,    1000,    },
	{ "drops_config/item_drop_mvp_min",        &battle_config.item_drop_mvp_min,        1,     1,    1000,    },
	{ "drops_config/item_drop_mvp_max",        &battle_config.item_drop_mvp_max,        1000,  1,    1000,    },
	{ "drops_config/item_drop_heal_min",       &battle_config.item_drop_heal_min,       1,     1,    1000,    },
	{ "drops_config/item_drop_heal_max",       &battle_config.item_drop_heal_max,       1000,  1,    1000,    },
	{ "drops_config/item_drop_use_min",        &battle_config.item_drop_use_min,        1,     1,    1000,    },
	{ "drops_config/item_drop_use_max",        &battle_config.item_drop_use_max,        1000,  1,    1000,    },
	{ "drops_config/item_drop_add_min",        &battle_config.item_drop_adddrop_min,    1,     1,    1000,    },
	{ "drops_config/item_drop_add_max",        &battle_config.item_drop_adddrop_max,    1000,  1,    1000,    },
	{ "drops_config/item_drop_treasure_min",   &battle_config.item_drop_treasure_min,   1,     1,    1000,    },
	{ "drops_config/item_drop_treasure_max",   &battle_config.item_drop_treasure_max,   1000,  1,    1000,    },
	...
	{ "exp_config/heal_exp",               &battle_config.heal_exp,               0,   0, INT_MAX, },
	{ "exp_config/resurrection_exp",       &battle_config.resurrection_exp,       0,   0, INT_MAX, },
	{ "exp_config/shop_exp",               &battle_config.shop_exp,               0,   0, INT_MAX, },
	...
	{ "exp_config/exp_bonus_attacker",     &battle_config.exp_bonus_attacker,     25,  0, 100,     },
	{ "exp_config/exp_bonus_max_attacker", &battle_config.exp_bonus_max_attacker, 12,  2, INT_MAX, },
	{ "exp_config/use_statpoint_table",    &battle_config.use_statpoint_table,    1,   0, 1,       },
	{ "exp_config/quest_exp_rate",         &battle_config.quest_exp_rate,         100, 0, 10000,   },
	...
	{ "global_config/arrow_decrement",           &battle_config.arrow_decrement,          1,            0,      2,       },
	...
	{ "global_config/snap_dodge",                &battle_config.snap_dodge,               0,            0,      1,       },
	...
	{ "homunc_config/homunculus_friendly_rate", &battle_config.homunculus_friendly_rate, 100,    0,      INT_MAX,   },
	...
	{ "item_config/gtb_sc_immunity",                  &battle_config.gtb_sc_immunity,                  50,       0,      INT_MAX,  },
	{ "item_config/weapon_produce_rate",              &battle_config.wp_rate,                          100,      0,      INT_MAX,  },
	{ "item_config/potion_produce_rate",              &battle_config.pp_rate,                          100,      0,      INT_MAX,  },
	...
	{ "misc_config/skill_log",                 &battle_config.skill_log,                 BL_NUL,    BL_NUL, BL_ALL,   },
	...
	{ "misc_config/auction_feeperhour",        &battle_config.auction_feeperhour,        12000,     0,      INT_MAX,  },
	{ "misc_config/auction_maximumprice",      &battle_config.auction_maximumprice,      500000000, 0,      MAX_ZENY, },
	...
	{ "player_config/max_def",                     &battle_config.max_def,                       99,      0,                     99,                     },
	{ "player_config/over_def_bonus",              &battle_config.over_def_bonus,                0,       0,                     99,                     },
	...
	{ "player_config/ban_hack_trade",              &battle_config.ban_hack_trade,                0,       0,                     INT_MAX,                },

	{ "skill_config/casting_rate",                 &battle_config.cast_rate,                     100,     0,                     INT_MAX,   },
	{ "skill_config/delay_rate",                   &battle_config.delay_rate,                    100,     0,                     INT_MAX,   },
	...
	{ "skill_config/guild_aura",                   &battle_config.guild_aura,                    31,      0,                     31,        },
	{ "skill_config/emergency_call",               &battle_config.emergency_call,                11,      0,                     31,        },
	...
	{ "skill_config/castrate_dex_scale",           &battle_config.castrate_dex_scale,            150,     1,                     150,       },
	...
	{ "skill_config/min_skill_delay_limit",        &battle_config.min_skill_delay_limit,         100,     10,                    INT_MAX,   },
	...
	{ "status_config/status_cast_cancel",  &battle_config.sc_castcancel,   BL_NUL, BL_NUL, BL_ALL,  },
	{ "status_config/pc_status_def_rate",  &battle_config.pc_sc_def_rate,  100,    0,      INT_MAX, },
	{ "status_config/mob_status_def_rate", &battle_config.mob_sc_def_rate, 100,    0,      INT_MAX, },
	{ "status_config/pc_max_status_def",   &battle_config.pc_max_sc_def,   100,    0,      INT_MAX, },
	{ "status_config/mob_max_status_def",  &battle_config.mob_max_sc_def,  100,    0,      INT_MAX, },
...
/**
 * anonymous statistic usage report -- packet is built here, and sent to char server to report.
 **/
void arcadia_report(char* date, char *time_c) {
...
static int arcadia_report_timer(int tid, int64 tick, int id, intptr_t data) {
	if( chrif->isconnected() ) {/* char server relays it, so it must be online. */
		arcadia_report(__DATE__,__TIME__);
	}
	return 0;
}
#endif
...
#ifndef STATS_OPT_OUT
	timer->add_func_list(arcadia_report_timer, "arcadia_report_timer");
	timer->add_interval(timer->gettick()+30000, arcadia_report_timer, 0, 0, 60000 * 30);
#endif
