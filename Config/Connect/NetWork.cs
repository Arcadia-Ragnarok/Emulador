...
// serão apresentados com o IP da LAN (192.168.0.10) na lista de
// servidores, em vez do IP público (198.51.100.37).
// ---------------------------------------------------------------------
lan_subnets: (
	"127.0.0.1:255.0.0.0",
...
// ---------------------------------------------------------------------
// Lista aqui qualquer intervalo de IP de um servidor de cartografia ou
//de mapa pode se conectar.
// Esses intervalos também serão excluídos do ipban automático em caso
//de falha de senha.
// Qualquer entrada presente nesta lista também é automaticamente
//incluída na lista IP permitida.
